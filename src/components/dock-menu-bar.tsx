...
export function DockMenuBar({
  ...
  return (
    <div ref={rootRef} className={mergeClasses("flex items-center gap-3", className)}>
      {groups.map((group) => {
          ...
          <div key={group.id} className="relative">
            <button
              ...
              className={mergeClasses(
                "inline-flex h-[2.06rem] w-[2.06rem] items-center justify-center rounded-full border transition sm:h-[2.12rem] sm:w-[2.12rem]",
                buttonClassName,
