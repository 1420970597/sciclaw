...
export function DockMenuBar({
  ...
  return (
    <div ref={rootRef} className={mergeClasses("flex items-center gap-[0.16rem] sm:gap-[0.2rem]", className)}>
      {groups.map((group) => {
          ...
          <div key={group.id} className="relative">
            <button
              ...
              className={mergeClasses(
                "inline-flex h-[2.48rem] w-[2.48rem] items-center justify-center rounded-full border transition sm:h-[2.56rem] sm:w-[2.56rem]",
                buttonClassName,
