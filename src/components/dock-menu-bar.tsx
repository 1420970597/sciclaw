...
export function DockMenuBar({
  ...
  return (
    <div ref={rootRef} className={mergeClasses("flex items-center gap-[0.42rem]", className)}>
      {groups.map((group) => {
          ...
          <div key={group.id} className="relative">
            <button
              ...
              className={mergeClasses(
                "inline-flex h-[2.75rem] w-[2.75rem] items-center justify-center rounded-full border transition sm:h-[2.8rem] sm:w-[2.8rem]",
                buttonClassName,
