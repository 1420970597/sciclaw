...
export function DockMenuBar({
  ...
  return (
    <div ref={rootRef} className={mergeClasses("flex items-center gap-[0.3rem] sm:gap-[0.37rem]", className)}>
      {groups.map((group) => {
          ...
          <div key={group.id} className="relative">
            <button
              ...
              className={mergeClasses(
                "inline-flex h-[2.84rem] w-[2.84rem] items-center justify-center rounded-full border transition sm:h-[2.96rem] sm:w-[2.96rem]",
                buttonClassName,
