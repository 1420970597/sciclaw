...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[308px] sm:max-w-[320px] lg:ml-auto lg:mr-[0.2rem] lg:-mt-[10.34rem] lg:max-w-[472px] xl:mr-[0.22rem] xl:-mt-[10.66rem] xl:max-w-[488px]"
      >
