...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[43.1%] top-[13.5%] sm:left-[43.1%] sm:top-[13.5%]",
      lineClass: "left-[42%] top-[27.78%] h-[2.02px] w-[15.6%] origin-left -rotate-[5deg]",
      ...
      labelPositionClass: "absolute left-[-1.96rem] top-[0.34rem] sm:left-[-2.04rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[42.9%] top-[46.55%] sm:left-[42.9%] sm:top-[46.55%]",
      lineClass: "left-[41.9%] top-[49.72%] h-[2.02px] w-[16.2%] origin-left rotate-[5deg]",
      ringClass: "h-[4.58rem] w-[4.58rem] border-[#4f697a] bg-[linear-gradient(180deg,#ffffff_0%,#f9fbfd_100%)] text-[#234356] shadow-[0_11px_20px_rgba(15,23,42,0.082)]",
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
    ...
    },
    {
      ...
      position: "right-[14.2%] top-[13.2%] sm:right-[14.2%] sm:top-[13.2%]",
      lineClass: "left-[48.62%] top-[27.54%] h-[2.02px] w-[8.9%] origin-left rotate-[10deg]",
      ringClass: "h-[4.58rem] w-[4.58rem] border-[#4f697a] bg-[linear-gradient(180deg,#ffffff_0%,#f9fbfd_100%)] text-[#234356] shadow-[0_11px_20px_rgba(15,23,42,0.082)]",
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
      ...
      labelPositionClass: "absolute left-[1.78rem] top-[0.38rem] sm:left-[1.86rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.18rem] w-full max-w-[232px] sm:max-w-[244px] lg:ml-auto lg:mr-[0.72rem] lg:-mt-[17.18rem] lg:max-w-[300px] xl:mr-[0.92rem] xl:-mt-[17.62rem] xl:max-w-[320px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.52rem] sm:mt-[2.96rem] lg:mt-[5.4rem] xl:mt-[5.74rem]">
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-4 sm:px-8 sm:pt-5 lg:px-10 lg:pt-6">
        <div className="space-y-[1.35rem] text-center sm:space-y-[1.52rem]">
          ...
          <div className="grid gap-3 sm:gap-[0.9rem] lg:-mt-[1.68rem] lg:pb-[0.72rem] xl:pb-[0.96rem]" data-testid="landing-hero">
            <FeatureRotator
