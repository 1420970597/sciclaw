...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.44rem] w-full max-w-[276px] sm:max-w-[288px] lg:ml-auto lg:mr-[0.4rem] lg:-mt-[12.3rem] lg:max-w-[404px] xl:mr-[0.42rem] xl:-mt-[12.64rem] xl:max-w-[420px]"
      >
