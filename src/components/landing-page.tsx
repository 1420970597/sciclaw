...
function FeaturePreview({
  ...
  return (
      <div className="flex flex-col gap-[1.08rem] lg:grid lg:grid-cols-[minmax(0,1fr)_224px] lg:items-start lg:gap-x-[0.04rem] lg:gap-y-[0.72rem] xl:grid-cols-[minmax(0,1fr)_224px] xl:gap-x-[0.08rem] xl:gap-y-[0.8rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:-ml-[0.08rem] lg:ml-auto lg:mt-[0.4rem] lg:max-w-[14.05rem] xl:-ml-[0.04rem] xl:mt-[0.48rem]">
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-5 sm:px-8 sm:pt-6 lg:px-10 lg:pt-7">
        <div className="space-y-5 text-center sm:space-y-6">
          ...
          <div className="grid gap-4 sm:gap-[1rem] lg:-mt-[2.12rem]" data-testid="landing-hero">
            <FeatureRotator
