...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.88rem] w-full max-w-[258px] sm:max-w-[270px] lg:ml-auto lg:mr-[1.62rem] lg:-mt-[15.42rem] lg:max-w-[376px] xl:mr-[1.82rem] xl:-mt-[15.78rem] xl:max-w-[392px]"
      >
