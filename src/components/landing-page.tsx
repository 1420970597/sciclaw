...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.56rem] w-full max-w-[272px] sm:max-w-[284px] lg:ml-auto lg:mr-[0.42rem] lg:-mt-[12.58rem] lg:max-w-[388px] xl:mr-[0.44rem] xl:-mt-[12.9rem] xl:max-w-[404px]"
      >
