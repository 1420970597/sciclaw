...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[0.28rem] w-full max-w-[340px] sm:max-w-[352px] lg:-mt-[2.72rem] lg:max-w-[680px] xl:-mt-[2.88rem] xl:max-w-[696px]">
