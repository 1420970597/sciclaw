...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    ...
    },
    {
      ...
      labelPositionClass: "absolute left-[1.5rem] top-[0.26rem] sm:left-[1.58rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[1.96rem] w-full max-w-[288px] sm:max-w-[300px] lg:ml-auto lg:mr-[0.34rem] lg:-mt-[11.54rem] lg:max-w-[428px] xl:mr-[0.36rem] xl:-mt-[11.88rem] xl:max-w-[444px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[6.24rem] xl:mt-[6.62rem]">
