...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.88rem] w-full max-w-[240px] sm:max-w-[252px] lg:ml-auto lg:mr-[1.48rem] lg:-mt-[16.82rem] lg:max-w-[316px] xl:mr-[1.78rem] xl:-mt-[17.2rem] xl:max-w-[336px]"
      >
