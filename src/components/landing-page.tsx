...
function FeatureRotator({
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-[2.05rem] bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.46),_rgba(255,255,255,0)_66%)] pl-[0.18rem] pr-0 py-1 sm:px-1 lg:-mt-[2.08rem] lg:-mr-[0.04rem] lg:px-0 lg:pl-[0.2rem] xl:-mt-[2.3rem] xl:-mr-[0.1rem] xl:px-1 xl:pl-[0.24rem]">
