...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[1.96rem] w-full max-w-[292px] sm:max-w-[304px] lg:ml-auto lg:mr-[0.32rem] lg:-mt-[11.42rem] lg:max-w-[436px] xl:mr-[0.34rem] xl:-mt-[11.76rem] xl:max-w-[452px]"
      >
