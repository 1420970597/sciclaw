...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.28rem] w-full max-w-[232px] sm:max-w-[244px] lg:ml-auto lg:mr-[0.54rem] lg:-mt-[17.04rem] lg:max-w-[296px] xl:mr-[0.74rem] xl:-mt-[17.38rem] xl:max-w-[316px]"
      >
