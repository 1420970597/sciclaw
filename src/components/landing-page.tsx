...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.18rem] w-full max-w-[228px] sm:max-w-[240px] lg:ml-auto lg:mr-[0.62rem] lg:-mt-[17.04rem] lg:max-w-[292px] xl:mr-[0.82rem] xl:-mt-[17.46rem] xl:max-w-[312px]"
      >
