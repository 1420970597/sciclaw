  ...
  return (
    <header className="pt-[0.72rem] sm:pt-[0.92rem]">
      <div className="mx-auto flex w-full max-w-[1180px] items-center justify-end px-5 sm:px-7 lg:px-[2.05rem] xl:px-[2.3rem]">
        <nav aria-label="Primary" className="flex items-center gap-[0.36rem] pr-[0.16rem] sm:gap-[0.48rem] sm:pr-[0.2rem]">
          <DockMenuBar
    ...
    () => [
      {
        ...
        icon: "文",
        position: "left-[15.1%] top-[9.9%] sm:left-[15.1%] sm:top-[9.9%]",
        lineClass: "left-[42.6%] top-[26.6%] h-[1px] w-[18.4%] origin-left rotate-[207deg]",
        ...
        labelClass: "max-w-[56px] text-[#4b5d6e] drop-shadow-[0_1px_0_rgba(255,255,255,0.95)]",
        activeLabelClass: "max-w-[56px] text-[#8b4215] drop-shadow-[0_2px_4px_rgba(240,142,79,0.022)]",
      },
      {
        id: "data-mining",
        label: "Data Mining",
        icon: "数",
        position: "left-[15.3%] top-[69.8%] sm:left-[15.3%] sm:top-[69.8%]",
        lineClass: "left-[42.5%] top-[48.3%] h-[1px] w-[18.8%] origin-left rotate-[145deg]",
        ringClass: "h-[3.14rem] w-[3.14rem] border-[#9aaab8] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#50606c] shadow-[0_2px_5px_rgba(15,23,42,0.022)]",
        activeRingClass: "h-[3.22rem] w-[3.22rem] border-[#dd9254] bg-[linear-gradient(180deg,#fffbf7_0%,#ffd8bc_100%)] text-[#ad4d17] shadow-[0_0_0_3px_rgba(240,142,79,0.024),0_7px_10px_rgba(232,124,55,0.04)]",
        labelClass: "max-w-[56px] text-[#4b5d6e] drop-shadow-[0_1px_0_rgba(255,255,255,0.95)]",
        activeLabelClass: "max-w-[56px] text-[#8b4215] drop-shadow-[0_2px_4px_rgba(240,142,79,0.022)]",
      },
      {
        ...
        icon: "果",
        position: "right-[9.1%] top-[10.5%] sm:right-[9.1%] sm:top-[10.5%]",
        lineClass: "left-[49.2%] top-[27.9%] h-[1px] w-[17.9%] origin-left rotate-[14deg]",
        ringClass: "h-[3.14rem] w-[3.14rem] border-[#9aaab8] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#50606c] shadow-[0_2px_5px_rgba(15,23,42,0.022)]",
        activeRingClass: "h-[3.22rem] w-[3.22rem] border-[#dd9254] bg-[linear-gradient(180deg,#fffbf7_0%,#ffd8bc_100%)] text-[#ad4d17] shadow-[0_0_0_3px_rgba(240,142,79,0.024),0_7px_10px_rgba(232,124,55,0.04)]",
        labelClass: "max-w-[58px] text-[#4b5d6e] drop-shadow-[0_1px_0_rgba(255,255,255,0.95)]",
  ...
  return (
    <div className="relative min-h-[366px] overflow-hidden rounded-[2rem] bg-[radial-gradient(circle_at_49%_48.9%,_rgba(255,255,255,0.84),_rgba(255,255,255,0)_60%)] sm:min-h-[424px]">
      <div className="absolute inset-0 opacity-[0.998]">
        ...
        <div className="absolute left-[48.98%] top-[21.3%] h-[118px] w-[0.9px] bg-gradient-to-b from-[#e48f52] via-[#d66f2a] to-transparent opacity-[0.82]" />
        <div className="absolute left-[49.84%] top-[21.3%] h-[118px] w-px bg-gradient-to-b from-[#fff2e6] via-[#fff6ef]/16 to-transparent opacity-[0.28]" />
        <div className="absolute left-[49.5%] top-[20.35%] h-[0.82rem] w-[0.82rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(244,177,132,0.0032)_0%,_rgba(244,177,132,0.0008)_32%,_rgba(255,255,255,0)_66%)]" />
        <div className="absolute left-[49.5%] top-[20.35%] h-[1.08rem] w-[1.08rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(255,242,231,0.042)_0%,_rgba(255,242,231,0)_74%)]" />
        <div className="absolute left-[49.5%] top-[20.35%] h-[3px] w-[3px] -translate-x-1/2 rounded-full border border-[#e08f54] bg-[#d86f28] shadow-[0_0_0_1.2px_rgba(242,154,98,0.01),0_3px_4px_rgba(232,124,55,0.02)]" />
        <div className="absolute left-[49.5%] top-[47.1%] h-[40px] w-[40px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,_rgba(244,177,132,0.0016)_0%,_rgba(244,177,132,0.0006)_28%,_rgba(255,255,255,0)_68%)]" />
        <div className="absolute left-[49.5%] top-[47.1%] h-[42px] w-[42px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#ddb088]/6 shadow-[0_0_1px_rgba(239,146,86,0.0012)]" />
        <div className="absolute left-[49.5%] top-[47.1%] h-[30px] w-[30px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#efd8c8]/48 shadow-[0_0_1px_rgba(239,146,86,0.0008)]" />
        {nodes.map((node) => {
          ...
          return (
            <div key={node.id}>
              <span className={`absolute ${node.lineClass} bg-gradient-to-r from-[#8498ac] via-[#d6dee6] to-transparent opacity-[0.78]`} aria-hidden />
              <button
                type="button"
                onClick={() => {
                  if (nextIndex >= 0) {
              ...
              >
                ...
                <span className={`text-[11.25px] font-medium leading-[2.02] tracking-[0.176em] sm:text-[0.805rem] ${isActive ? node.activeLabelClass : node.labelClass}`}>{node.label}</span>
              </button>
            </div>
          );
        })}
          ...
          <div className="mt-[1.36rem] grid gap-[1.42rem] lg:grid-cols-[1fr_1.05fr]">
            ...
            <div className="rounded-[1.35rem] border border-[#f0e4d8] bg-white/80 p-[1.28rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.62)]">
              <div className="space-y-[1.46rem]">
                ...
                <div className="mt-[2.32rem] grid grid-cols-4 gap-[1.34rem] pt-[2.02rem] sm:gap-[1.58rem]">
                  {bars.map((height, index) => (
                    <div key={`${activeFeature.id}-${index}`} className="flex min-w-[0] flex-1 flex-col items-center gap-[0.74rem] text-center sm:gap-[0.84rem]">
                      ...
                      <span className="w-full max-w-[2.9rem] text-center text-[9.25px] font-medium uppercase leading-[1.46] tracking-[0.206em] text-[#264156] sm:max-w-[3.1rem] sm:text-[9.4px] sm:tracking-[0.214em]">
