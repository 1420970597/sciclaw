    ...
    () => [
      {
        ...
        icon: "文",
        position: "left-[54.55%] top-[19.15%] sm:left-[54.55%] sm:top-[19.15%]",
        lineClass: "left-[50.02%] top-[34.2%] h-[1.9px] w-[5.95%] origin-left rotate-[187deg]",
        ringClass: "h-[4.26rem] w-[4.26rem] border-[#446075] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-[#1f3849] shadow-[0_15px_28px_rgba(15,23,42,0.112)]",
        activeRingClass: "h-[4.34rem] w-[4.34rem] border-[#db8b4f] bg-[linear-gradient(180deg,#fffbf7_0%,#ffd7bb_100%)] text-[#a64814] shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_16px_29px_rgba(232,124,55,0.098)]",
        labelClass: "max-w-[118px] text-[#284456] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
        activeLabelClass: "max-w-[108px] text-[#864015] drop-shadow-[0_2px_4px_rgba(240,142,79,0.042)]",
      },
      {
        id: "data-mining",
        label: "Data Mining",
        icon: "数",
        position: "left-[54.65%] top-[48.05%] sm:left-[54.65%] sm:top-[48.05%]",
        lineClass: "left-[49.98%] top-[44.18%] h-[1.9px] w-[6.08%] origin-left rotate-[161deg]",
        ringClass: "h-[4.26rem] w-[4.26rem] border-[#446075] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-[#1f3849] shadow-[0_15px_28px_rgba(15,23,42,0.112)]",
        activeRingClass: "h-[4.34rem] w-[4.34rem] border-[#db8b4f] bg-[linear-gradient(180deg,#fffbf7_0%,#ffd7bb_100%)] text-[#a64814] shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_16px_29px_rgba(232,124,55,0.098)]",
        labelClass: "max-w-[118px] text-[#284456] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
        activeLabelClass: "max-w-[108px] text-[#864015] drop-shadow-[0_2px_4px_rgba(240,142,79,0.042)]",
      },
      {
        ...
        icon: "果",
        position: "right-[34.4%] top-[19.2%] sm:right-[34.4%] sm:top-[19.2%]",
        lineClass: "left-[50.04%] top-[34.26%] h-[1.9px] w-[5.92%] origin-left rotate-[32deg]",
        ringClass: "h-[4.26rem] w-[4.26rem] border-[#446075] bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] text-[#1f3849] shadow-[0_15px_28px_rgba(15,23,42,0.112)]",
        activeRingClass: "h-[4.34rem] w-[4.34rem] border-[#db8b4f] bg-[linear-gradient(180deg,#fffbf7_0%,#ffd7bb_100%)] text-[#a64814] shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_16px_29px_rgba(232,124,55,0.098)]",
        labelClass: "max-w-[118px] text-[#284456] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
        activeLabelClass: "max-w-[108px] text-[#864015] drop-shadow-[0_2px_4px_rgba(240,142,79,0.042)]",
