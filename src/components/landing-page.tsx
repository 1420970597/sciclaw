...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[198px] sm:max-w-[210px] lg:ml-auto lg:mr-[0.22rem] lg:-mt-[15.86rem] lg:max-w-[254px] xl:mr-[0.36rem] xl:-mt-[16.14rem] xl:max-w-[274px]"
      >
