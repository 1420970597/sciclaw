...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelClass: "max-w-[110px] text-left text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[110px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[-5.9rem] top-[0.02rem] sm:left-[-6.15rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeRingClass: "h-[4.9rem] w-[4.9rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.05),0_13px_21px_rgba(232,124,55,0.086)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[104px] text-center text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[104px] text-center text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+1.08rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      labelPositionClass: "absolute left-[4.96rem] top-[0.08rem] sm:left-[5.18rem]",
    },
    ],
    [],
  );
