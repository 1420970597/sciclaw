...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[192px] sm:max-w-[204px] lg:ml-auto lg:mr-[0.18rem] lg:-mt-[15.7rem] lg:max-w-[248px] xl:mr-[0.32rem] xl:-mt-[15.96rem] xl:max-w-[268px]"
      >
