...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.08rem] w-full max-w-[316px] sm:max-w-[328px] lg:ml-auto lg:mr-[0.08rem] lg:-mt-[10.16rem] lg:max-w-[504px] xl:mr-[0.1rem] xl:-mt-[10.5rem] xl:max-w-[520px]"
      >
