...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[43.9%] top-[11.4%] sm:left-[43.9%] sm:top-[11.4%]",
      lineClass: "left-[45.95%] top-[27.3%] h-[2.18px] w-[15.2%] origin-left -rotate-[22deg]",
      ...
      labelClass: "max-w-[108px] text-left text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[108px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[-5.1rem] top-[0.08rem] sm:left-[-5.35rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[44.5%] top-[51.35%] sm:left-[44.5%] sm:top-[51.35%]",
      lineClass: "left-[46.1%] top-[53.8%] h-[2.18px] w-[15.02%] origin-left rotate-[17deg]",
      ringClass: "h-[4.78rem] w-[4.78rem] border-[#476373] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_11px_18px_rgba(15,23,42,0.076)]",
      activeRingClass: "h-[4.9rem] w-[4.9rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.05),0_13px_21px_rgba(232,124,55,0.086)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[102px] text-center text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[102px] text-center text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+0.84rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[10.8%] top-[11.15%] sm:right-[10.8%] sm:top-[11.15%]",
      lineClass: "left-[47.54%] top-[27.46%] h-[2.18px] w-[14.92%] origin-left rotate-[24deg]",
      ringClass: "h-[4.78rem] w-[4.78rem] border-[#476373] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_11px_18px_rgba(15,23,42,0.076)]",
      activeRingClass: "h-[4.9rem] w-[4.9rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.05),0_13px_21px_rgba(232,124,55,0.086)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[112px] text-left text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[112px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[4.58rem] top-[0.12rem] sm:left-[4.82rem]",
    },
    ],
    [],
  );
