...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.34rem] w-full max-w-[228px] sm:max-w-[240px] lg:ml-auto lg:mr-[0.48rem] lg:-mt-[17.18rem] lg:max-w-[292px] xl:mr-[0.68rem] xl:-mt-[17.52rem] xl:max-w-[312px]"
      >
