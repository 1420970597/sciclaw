...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[186px] sm:max-w-[198px] lg:ml-auto lg:mr-[0.14rem] lg:-mt-[15.52rem] lg:max-w-[242px] xl:mr-[0.28rem] xl:-mt-[15.8rem] xl:max-w-[262px]"
      >
