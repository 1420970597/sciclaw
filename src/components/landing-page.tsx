...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.38rem] sm:mt-[2.8rem] lg:mt-[5.22rem] xl:mt-[5.5rem]">
        <div className="mb-[2rem] flex flex-col items-center gap-2.5 text-center">
