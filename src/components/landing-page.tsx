...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[1.8rem] w-full max-w-[324px] sm:max-w-[336px] lg:-mt-[9.04rem] lg:max-w-[548px] xl:-mt-[9.34rem] xl:max-w-[564px]">
