...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[48.85%] top-[14.95%] sm:left-[48.85%] sm:top-[14.95%]",
      lineClass: "left-[48.38%] top-[29.38%] h-[2.18px] w-[10.35%] origin-left -rotate-[13deg]",
      ...
      labelClass: "max-w-[104px] text-left text-[#314d61] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[104px] text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-[-1.58rem] top-[0.16rem] sm:left-[-1.66rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[48.7%] top-[46.55%] sm:left-[48.7%] sm:top-[46.55%]",
      lineClass: "left-[48.22%] top-[50.7%] h-[2.18px] w-[10.2%] origin-left rotate-[7deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[104px] text-center text-[#314d61] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[104px] text-center text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%-0.06rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[15.6%] top-[13.8%] sm:right-[15.6%] sm:top-[13.8%]",
      lineClass: "left-[48.62%] top-[28.72%] h-[2.18px] w-[10.3%] origin-left rotate-[12deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      ...
      labelPositionClass: "absolute left-[2.22rem] top-1/2 -translate-y-1/2 sm:left-[2.34rem]",
    },
    ],
    [],
  );
