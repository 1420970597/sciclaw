...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[1.88rem] w-full max-w-[296px] sm:max-w-[308px] lg:ml-auto lg:mr-[0.26rem] lg:-mt-[10.74rem] lg:max-w-[448px] xl:mr-[0.28rem] xl:-mt-[11.06rem] xl:max-w-[464px]"
      >
