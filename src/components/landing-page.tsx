...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[48.6%] top-[13.6%] sm:left-[48.6%] sm:top-[13.6%]",
      lineClass: "left-[47.4%] top-[28.2%] h-[2.02px] w-[10.8%] origin-left -rotate-[7deg]",
    ...
    },
    {
      ...
      labelPositionClass: "absolute left-1/2 top-[calc(100%-0.42rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      labelPositionClass: "absolute left-[2.16rem] top-[0.28rem] sm:left-[2.24rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.08rem] w-full max-w-[316px] sm:max-w-[328px] lg:ml-auto lg:mr-[0.08rem] lg:-mt-[10.28rem] lg:max-w-[504px] xl:mr-[0.1rem] xl:-mt-[10.62rem] xl:max-w-[520px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[7rem] xl:mt-[7.38rem]">
