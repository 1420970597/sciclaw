...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[47.8%] top-[13.25%] sm:left-[47.8%] sm:top-[13.25%]",
      lineClass: "left-[46.9%] top-[27.9%] h-[2.02px] w-[11.2%] origin-left -rotate-[8deg]",
      ...
      labelPositionClass: "absolute left-[-1.94rem] top-[-0.04rem] sm:left-[-2.02rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[2.32rem] w-full max-w-[320px] sm:max-w-[332px] lg:-mt-[10.12rem] lg:max-w-[548px] xl:-mt-[10.46rem] xl:max-w-[564px]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[244px] rounded-[0.9rem] border border-[rgba(244,247,250,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.76)_100%)] px-[0.26rem] py-[0.3rem] shadow-[0_2px_5px_rgba(15,23,42,0.01),0_1px_2px_rgba(241,180,135,0.003)] backdrop-blur-[0.24px] sm:px-[0.29rem] sm:py-[0.32rem] lg:max-w-[540px] xl:max-w-[556px]"
    >
      <div className="mx-auto w-full max-w-[278px] lg:max-w-[548px] xl:max-w-[564px]">
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.68rem] sm:mt-[3.1rem] lg:mt-[6.56rem] xl:mt-[6.92rem]">
