...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelPositionClass: "absolute left-[-1.88rem] top-[0.46rem] sm:left-[-1.94rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[130px] whitespace-nowrap text-center text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[130px] whitespace-nowrap text-center text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
    ...
    },
    {
      ...
      labelPositionClass: "absolute left-[1.78rem] top-[0.36rem] sm:left-[1.88rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.88rem] w-full max-w-[248px] sm:max-w-[260px] lg:ml-auto lg:mr-[1.48rem] lg:-mt-[16.82rem] lg:max-w-[344px] xl:mr-[1.78rem] xl:-mt-[17.2rem] xl:max-w-[364px]"
      >
...
function FeatureRotator({
  ...
  return (
    ...
    >
      <div className="overflow-visible rounded-[2.05rem] bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.46),_rgba(255,255,255,0)_66%)] pl-[0.34rem] pr-0 py-1 sm:px-1 sm:pl-[0.4rem] lg:-mt-[0.28rem] lg:-mr-[0.08rem] lg:px-0 lg:pl-[0.42rem] xl:-mt-[0.38rem] xl:-mr-[0.12rem] xl:px-1 xl:pl-[0.5rem]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[224px] rounded-[0.78rem] border border-[rgba(247,249,252,0.86)] bg-[linear-gradient(180deg,rgba(255,255,255,0.974)_0%,rgba(249,244,237,0.46)_100%)] px-[0.18rem] py-[0.18rem] shadow-[0_1px_2px_rgba(15,23,42,0.0025),0_1px_2px_rgba(241,180,135,0.00055)] backdrop-blur-[0.05px] sm:px-[0.2rem] sm:py-[0.2rem] lg:max-w-[508px] xl:max-w-[524px]"
    >
      <div className="mx-auto w-full max-w-[258px] lg:max-w-[512px] xl:max-w-[528px]">
        <div className="rounded-[0.82rem] border border-[rgba(252,252,253,0.87)] bg-[linear-gradient(180deg,rgba(255,255,255,0.928)_0%,rgba(249,244,237,0.55)_100%)] p-[0.2rem] shadow-[0_2px_4px_rgba(15,23,42,0.0045)]">
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[4.98rem] xl:mt-[5.28rem]">
