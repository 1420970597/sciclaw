...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[46.1%] top-[14.2%] sm:left-[46.1%] sm:top-[14.2%]",
      lineClass: "left-[46.55%] top-[28.9%] h-[2.18px] w-[12.8%] origin-left -rotate-[17deg]",
      ...
      labelClass: "max-w-[76px] text-left text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[76px] text-left text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
      labelPositionClass: "absolute left-[-3.7rem] top-[0.24rem] sm:left-[-3.82rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[46.05%] top-[48.1%] sm:left-[46.05%] sm:top-[48.1%]",
      lineClass: "left-[46.55%] top-[52.1%] h-[2.18px] w-[12.9%] origin-left rotate-[11deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[80px] text-center text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[80px] text-center text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+0.58rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[15.4%] top-[14.4%] sm:right-[15.4%] sm:top-[14.4%]",
      lineClass: "left-[48.05%] top-[29.2%] h-[2.18px] w-[12.2%] origin-left rotate-[19deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[80px] text-left text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[80px] text-left text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
      labelPositionClass: "absolute left-[3.56rem] top-[0.24rem] sm:left-[3.7rem]",
    },
    ],
    [],
  );
            ...
            <div className="rounded-[1.44rem] border border-[#ead7c5] bg-white/95 p-[1.34rem] shadow-[0_8px_20px_rgba(15,23,42,0.032),inset_0_1px_0_rgba(255,255,255,0.78)]">
              <div className="space-y-[1.54rem]">
                ...
                <div
                  ...
                  className={`mt-[2.98rem] grid ${chartGridClass} gap-[3.38rem] px-[1.1rem] pt-[2.86rem] sm:gap-[3.54rem]`}
                >
                  {visibleBars.map((height, index) => (
                    <div key={`${activeFeature.id}-${index}`} className="flex min-w-[0] flex-1 flex-col items-center gap-[1.18rem] text-center sm:gap-[1.22rem]">
                      ...
                      <span className="flex min-h-[4.92rem] w-full min-w-0 items-start justify-center px-[0.78rem] pb-[0.04rem] text-center text-[11.2px] font-medium uppercase leading-[1.08] tracking-[0.028em] text-[#6b8191] sm:min-h-[5.08rem] sm:text-[11.36px] sm:tracking-[0.034em]">
                        <span className="block max-w-[6.18rem] text-balance break-words">{visibleChartLabels[index] ?? `Q${index + 1}`}</span>
                      </span>
                    </div>
                  ))}
                </div>
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[228px] rounded-[1.42rem] border border-[#f6f8fb] bg-[#fdfdff] px-[0.44rem] py-[0.52rem] shadow-[0_1px_2px_rgba(15,23,42,0.004),0_1px_2px_rgba(241,180,135,0.0015)] sm:px-[0.48rem] sm:py-[0.56rem] lg:mt-[2.08rem] xl:mt-[2.28rem]"
    >
      <div className="mx-auto w-full max-w-[272px]">
        ...
        <div className="mt-3.5 space-y-[1.08rem]">
          <div
            ...
            className="rounded-[1.16rem] border border-[#f3f5f8] bg-[#fdfefe] p-[0.68rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.88),0_2px_6px_rgba(15,23,42,0.012)] sm:p-[0.72rem]"
          >
            {activeMode === "onboard" ? (
