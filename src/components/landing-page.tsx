...
function FeaturePreview({
  ...
  return (
    <div className="flex flex-col gap-[1.2rem] lg:grid lg:grid-cols-[minmax(0,1fr)_232px] lg:items-start lg:gap-x-[0.06rem] lg:gap-y-[0.9rem] xl:grid-cols-[minmax(0,1fr)_232px] xl:gap-x-[0.12rem] xl:gap-y-[0.96rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:-ml-[0.06rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:ml-auto lg:mt-[0.34rem] lg:max-w-[14.5rem] xl:-ml-[0.02rem] xl:mt-[0.4rem]">
