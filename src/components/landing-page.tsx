...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[0.34rem] w-full max-w-[332px] sm:max-w-[344px] lg:-mt-[4.22rem] lg:max-w-[588px] xl:-mt-[4.42rem] xl:max-w-[604px]">
