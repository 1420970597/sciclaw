...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[45.1%] top-[11.4%] sm:left-[45.1%] sm:top-[11.4%]",
      lineClass: "left-[47.2%] top-[27.3%] h-[2.18px] w-[13.9%] origin-left -rotate-[22deg]",
      ...
      labelClass: "max-w-[98px] text-left text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[98px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[-5.65rem] top-[0.12rem] sm:left-[-5.95rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[45.7%] top-[50.8%] sm:left-[45.7%] sm:top-[50.8%]",
      lineClass: "left-[47.36%] top-[53.28%] h-[2.18px] w-[14.26%] origin-left rotate-[17deg]",
      ringClass: "h-[4.78rem] w-[4.78rem] border-[#476373] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_11px_18px_rgba(15,23,42,0.076)]",
      activeRingClass: "h-[4.9rem] w-[4.9rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.05),0_13px_21px_rgba(232,124,55,0.086)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[94px] text-center text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[94px] text-center text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+1.02rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[12.9%] top-[11.2%] sm:right-[12.9%] sm:top-[11.2%]",
      lineClass: "left-[47.54%] top-[27.46%] h-[2.18px] w-[13.7%] origin-left rotate-[24deg]",
      ringClass: "h-[4.78rem] w-[4.78rem] border-[#476373] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_11px_18px_rgba(15,23,42,0.076)]",
      activeRingClass: "h-[4.9rem] w-[4.9rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.05),0_13px_21px_rgba(232,124,55,0.086)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[104px] text-left text-[#4f6372] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[104px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[4.98rem] top-[0.14rem] sm:left-[5.18rem]",
    },
    ],
    [],
  );
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-7 sm:px-8 sm:pt-8 lg:px-10 lg:pt-10">
        <div className="space-y-8 text-center sm:space-y-9">
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_318px] lg:items-center lg:gap-[1.64rem] xl:grid-cols-[minmax(0,1.01fr)_318px] xl:gap-[1.88rem]" data-testid="landing-hero">
            <FeatureRotator
