...
function FeaturePreview({
  ...
  return (
      <div className="flex flex-col gap-[1.08rem] lg:grid lg:grid-cols-[minmax(0,1fr)_232px] lg:items-start lg:gap-x-[0.08rem] lg:gap-y-[0.72rem] xl:grid-cols-[minmax(0,1fr)_232px] xl:gap-x-[0.12rem] xl:gap-y-[0.8rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:ml-auto lg:mt-[0.3rem] lg:max-w-[14.5rem] xl:mt-[0.38rem]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[220px] rounded-[1.02rem] border border-[rgba(243,246,249,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.93)_100%)] px-[0.32rem] py-[0.36rem] shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_2px_rgba(241,180,135,0.005)] backdrop-blur-[0.58px] sm:px-[0.36rem] sm:py-[0.4rem]"
    >
