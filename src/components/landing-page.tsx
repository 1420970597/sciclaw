...
function FeaturePreview({
  ...
  return (
    <div className="flex flex-col gap-[1.2rem] lg:grid lg:grid-cols-[minmax(0,1fr)_236px] lg:items-start lg:gap-x-[0rem] lg:gap-y-[0.9rem] xl:grid-cols-[minmax(0,1fr)_236px] xl:gap-x-[0.04rem] xl:gap-y-[0.96rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:-ml-[0.14rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:ml-auto lg:mt-[0.34rem] lg:max-w-[14.75rem] xl:-ml-[0.1rem] xl:mt-[0.42rem]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[224px] rounded-[1.04rem] border border-[rgba(241,245,249,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.997)_0%,rgba(252,248,243,0.95)_100%)] px-[0.34rem] py-[0.38rem] shadow-[0_3px_8px_rgba(15,23,42,0.013),0_1px_2px_rgba(241,180,135,0.006)] backdrop-blur-[0.68px] sm:px-[0.38rem] sm:py-[0.42rem]"
    >
