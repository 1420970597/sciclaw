...
function FeaturePreview({
  ...
  return (
    <div className="flex flex-col gap-[1.2rem] lg:grid lg:grid-cols-[minmax(0,1fr)_228px] lg:items-start lg:gap-x-[0.02rem] lg:gap-y-[0.9rem] xl:grid-cols-[minmax(0,1fr)_228px] xl:gap-x-[0.08rem] xl:gap-y-[0.96rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:-ml-[0.1rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:ml-auto lg:mt-[0.46rem] lg:max-w-[14.25rem] xl:-ml-[0.06rem] xl:mt-[0.54rem]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[218px] rounded-[1rem] border border-[rgba(243,247,250,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.94)_100%)] px-[0.32rem] py-[0.36rem] shadow-[0_2px_6px_rgba(15,23,42,0.012),0_1px_2px_rgba(241,180,135,0.006)] backdrop-blur-[0.72px] sm:px-[0.36rem] sm:py-[0.4rem]"
    >
