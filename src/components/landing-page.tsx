...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[1.92rem] w-full max-w-[320px] sm:max-w-[332px] lg:-mt-[9.52rem] lg:max-w-[536px] xl:-mt-[9.84rem] xl:max-w-[552px]">
