      ...
      <div className="mx-auto flex w-full max-w-[1180px] items-center justify-end px-5 sm:px-7 lg:px-[2.05rem] xl:px-[2.3rem]">
        <nav aria-label="Primary" className="flex items-center gap-[0.58rem] pr-[0.03rem] sm:gap-[0.72rem] sm:pr-[0.05rem]">
          <DockMenuBar
            ...
            buttonClassName="border-[rgba(0,0,0,0.254)] bg-[linear-gradient(180deg,rgba(255,255,255,0.998)_0%,rgba(250,247,243,0.996)_100%)] text-[#233b4f] shadow-[0_1px_2px_rgba(15,23,42,0.02),0_3px_8px_rgba(15,23,42,0.02),inset_0_1px_0_rgba(255,255,255,0.998)] hover:-translate-y-0.5 hover:border-[rgba(0,0,0,0.278)] hover:text-[#142c3f]"
...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      icon: "文",
      position: "left-[57.8%] top-[14.6%] sm:left-[57.8%] sm:top-[14.6%]",
      lineClass: "left-[50.02%] top-[30.15%] h-[1.72px] w-[9.55%] origin-left rotate-[188deg]",
      ringClass: "h-[4.52rem] w-[4.52rem] border-[#51687c] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#183246] shadow-[0_15px_24px_rgba(15,23,42,0.096)]",
    ...
    },
    {
      ...
      label: "Data Mining",
      icon: "数",
      position: "left-[58.05%] top-[38.95%] sm:left-[58.05%] sm:top-[38.95%]",
      lineClass: "left-[50.02%] top-[39.18%] h-[1.72px] w-[9.85%] origin-left rotate-[163deg]",
      ringClass: "h-[4.52rem] w-[4.52rem] border-[#51687c] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#183246] shadow-[0_15px_24px_rgba(15,23,42,0.096)]",
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#dd8f53] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_17px_30px_rgba(232,124,55,0.092)]",
      labelClass: "max-w-[108px] text-[#385163] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[102px] text-[#844015] drop-shadow-[0_2px_4px_rgba(240,142,79,0.03)]",
    },
    {
      ...
      icon: "果",
      position: "right-[18.9%] top-[14.15%] sm:right-[18.9%] sm:top-[14.15%]",
      lineClass: "left-[49.9%] top-[30.08%] h-[1.72px] w-[9.9%] origin-left rotate-[24deg]",
      ringClass: "h-[4.52rem] w-[4.52rem] border-[#51687c] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#183246] shadow-[0_15px_24px_rgba(15,23,42,0.096)]",
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#dd8f53] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_17px_30px_rgba(232,124,55,0.092)]",
      labelClass: "max-w-[108px] text-[#385163] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[102px] text-[#844015] drop-shadow-[0_2px_4px_rgba(240,142,79,0.03)]",
          ...
          <div className="mt-[1.36rem] grid gap-[1.42rem] lg:grid-cols-[1fr_1.05fr]">
            ...
            <div className="rounded-[1.35rem] border border-[#f0e4d8] bg-white/80 p-[1.28rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.62)]">
              <div className="space-y-[1.46rem]">
                ...
                <div className="mt-[2.84rem] grid grid-cols-4 gap-[2.26rem] pt-[3.56rem] sm:gap-[2.4rem]">
                  {bars.map((height, index) => (
                    <div key={`${activeFeature.id}-${index}`} className="flex min-w-[0] flex-1 flex-col items-center gap-[1.28rem] text-center sm:gap-[1.34rem]">
                      ...
                      <span className="flex min-h-[3.84rem] w-full min-w-0 items-start justify-center px-[0.16rem] text-center text-[13px] font-medium uppercase leading-[1.38] tracking-[0.014em] text-[#4d6678] sm:min-h-[3.9rem] sm:text-[13.08px] sm:tracking-[0.016em]">
                        <span className="block max-w-[5.25rem] text-balance break-words">{previewContent.chartLabels[index] ?? `Q${index + 1}`}</span>
                      </span>
                    </div>
                  ))}
                </div>
