...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[172px] sm:max-w-[184px] lg:ml-auto lg:mr-[0.03rem] lg:-mt-[15.02rem] lg:max-w-[224px] xl:mr-[0.16rem] xl:-mt-[15.28rem] xl:max-w-[244px]"
      >
