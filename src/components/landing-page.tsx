...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      activeLabelClass: "max-w-[77px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[-4.55rem] top-[0.18rem] sm:left-[-4.7rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeLabelClass: "max-w-[82px] text-center text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+0.88rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      activeLabelClass: "max-w-[84px] text-left text-[#8a4619] drop-shadow-[0_2px_4px_rgba(240,142,79,0.024)]",
      labelPositionClass: "absolute left-[4.3rem] top-[0.18rem] sm:left-[4.46rem]",
    },
    ],
    [],
  );
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[318px] rounded-[1.95rem] border border-[#edf1f5] bg-[#fcfdff] px-[0.96rem] py-[1rem] shadow-[0_12px_24px_rgba(15,23,42,0.032),0_6px_16px_rgba(241,180,135,0.045)] sm:px-[1rem] sm:py-[1.02rem] lg:mt-[0.58rem] xl:mt-[0.7rem]"
    >
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-7 sm:px-8 sm:pt-8 lg:px-10 lg:pt-10">
        <div className="space-y-8 text-center sm:space-y-9">
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_318px] lg:items-start lg:gap-[1.18rem] xl:grid-cols-[minmax(0,1.02fr)_318px] xl:gap-[1.42rem]" data-testid="landing-hero">
            <FeatureRotator
