...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.08rem] w-full max-w-[316px] sm:max-w-[328px] lg:ml-auto lg:mr-[0.08rem] lg:-mt-[9.84rem] lg:max-w-[504px] xl:mr-[0.1rem] xl:-mt-[10.18rem] xl:max-w-[520px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[6.72rem] xl:mt-[7.08rem]">
