...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.94rem] w-full max-w-[240px] sm:max-w-[252px] lg:ml-auto lg:mr-[1.08rem] lg:-mt-[17.58rem] lg:max-w-[312px] xl:mr-[1.32rem] xl:-mt-[18rem] xl:max-w-[332px]"
      >
