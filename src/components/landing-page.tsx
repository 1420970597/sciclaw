...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.88rem] w-full max-w-[258px] sm:max-w-[270px] lg:ml-auto lg:mr-[1.94rem] lg:-mt-[15.88rem] lg:max-w-[388px] xl:mr-[2.18rem] xl:-mt-[16.26rem] xl:max-w-[408px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[5.2rem] xl:mt-[5.56rem]">
