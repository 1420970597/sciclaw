...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.18rem] w-full max-w-[236px] sm:max-w-[248px] lg:ml-auto lg:mr-[0.48rem] lg:-mt-[17.02rem] lg:max-w-[304px] xl:mr-[0.64rem] xl:-mt-[17.42rem] xl:max-w-[324px]"
      >
