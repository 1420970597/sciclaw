...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelClass: "max-w-[84px] text-left text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[84px] text-left text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
      labelPositionClass: "absolute left-[-4.18rem] top-[0.12rem] sm:left-[-4.28rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeLabelClass: "max-w-[88px] text-center text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
    ...
    },
    {
      ...
      activeLabelClass: "max-w-[88px] text-left text-[#7a4a27] drop-shadow-[0_2px_3px_rgba(240,142,79,0.016)]",
      labelPositionClass: "absolute left-[4.12rem] top-[0.12rem] sm:left-[4.26rem]",
    },
    ],
    [],
  );
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[258px] rounded-[1.56rem] border border-[#f5f8fb] bg-[#fdfdff] px-[0.54rem] py-[0.62rem] shadow-[0_1px_3px_rgba(15,23,42,0.008),0_1px_2px_rgba(241,180,135,0.004)] sm:px-[0.58rem] sm:py-[0.66rem] lg:mt-[2.74rem] xl:mt-[2.96rem]"
    >
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-7 sm:px-8 sm:pt-8 lg:px-10 lg:pt-10">
        <div className="space-y-8 text-center sm:space-y-9">
          ...
          <div className="grid gap-5 lg:-mt-[2.92rem] lg:grid-cols-[minmax(0,1fr)_258px] lg:items-start lg:gap-[0.08rem] xl:-mt-[3.16rem] xl:grid-cols-[minmax(0,1.12fr)_258px] xl:gap-[0.12rem]" data-testid="landing-hero">
            <FeatureRotator
