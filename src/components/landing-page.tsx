...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelClass: "max-w-[88px] text-left text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[88px] text-left text-[#6f4526] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-[-3.2rem] top-[0.34rem] sm:left-[-3.32rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[46.45%] top-[47.7%] sm:left-[46.45%] sm:top-[47.7%]",
      lineClass: "left-[46.85%] top-[51.2%] h-[2.18px] w-[12.45%] origin-left rotate-[10deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[88px] text-center text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[88px] text-center text-[#6f4526] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+0.72rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[15.95%] top-[14.55%] sm:right-[15.95%] sm:top-[14.55%]",
      lineClass: "left-[48.12%] top-[29.55%] h-[2.18px] w-[11.6%] origin-left rotate-[18deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[88px] text-left text-[#365164] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[88px] text-left text-[#6f4526] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-[3.34rem] top-[0.34rem] sm:left-[3.48rem]",
    },
    ],
    [],
  );
