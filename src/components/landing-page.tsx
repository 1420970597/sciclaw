...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[48.4%] top-[15.3%] sm:left-[48.4%] sm:top-[15.3%]",
      lineClass: "left-[48.18%] top-[29.65%] h-[2.18px] w-[10.8%] origin-left -rotate-[13deg]",
      ...
      labelPositionClass: "absolute left-[-1.84rem] top-[0.28rem] sm:left-[-1.92rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[48.25%] top-[46.9%] sm:left-[48.25%] sm:top-[46.9%]",
      lineClass: "left-[48.02%] top-[50.92%] h-[2.18px] w-[10.6%] origin-left rotate-[7deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
    ...
    },
    {
      ...
      position: "right-[16.2%] top-[14.0%] sm:right-[16.2%] sm:top-[14.0%]",
      lineClass: "left-[48.45%] top-[28.95%] h-[2.18px] w-[10.7%] origin-left rotate-[12deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      ...
      labelPositionClass: "absolute left-[2.46rem] top-1/2 -translate-y-1/2 sm:left-[2.58rem]",
    },
    ],
    [],
  );
