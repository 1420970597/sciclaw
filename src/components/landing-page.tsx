...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.18rem] w-full max-w-[236px] sm:max-w-[248px] lg:ml-auto lg:mr-[0.62rem] lg:-mt-[16.84rem] lg:max-w-[304px] xl:mr-[0.82rem] xl:-mt-[17.2rem] xl:max-w-[324px]"
      >
