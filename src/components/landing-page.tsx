...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[180px] sm:max-w-[192px] lg:ml-auto lg:mr-[0.1rem] lg:-mt-[15.34rem] lg:max-w-[236px] xl:mr-[0.24rem] xl:-mt-[15.62rem] xl:max-w-[256px]"
      >
