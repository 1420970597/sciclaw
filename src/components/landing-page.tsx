...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelClass: "max-w-[120px] whitespace-nowrap text-left text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[120px] whitespace-nowrap text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
      labelPositionClass: "absolute left-[-1.72rem] top-[0.38rem] sm:left-[-1.8rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[122px] whitespace-nowrap text-center text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[122px] whitespace-nowrap text-center text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
    ...
    },
    {
      ...
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[118px] whitespace-nowrap text-left text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[118px] whitespace-nowrap text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
      labelPositionClass: "absolute left-[1.52rem] top-[0.28rem] sm:left-[1.62rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.94rem] w-full max-w-[240px] sm:max-w-[252px] lg:ml-auto lg:mr-[1.08rem] lg:-mt-[17.2rem] lg:max-w-[316px] xl:mr-[1.32rem] xl:-mt-[17.58rem] xl:max-w-[336px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.52rem] sm:mt-[2.96rem] lg:mt-[5.62rem] xl:mt-[5.92rem]">
        <div className="mb-[2.12rem] flex flex-col items-center gap-2.5 text-center">
