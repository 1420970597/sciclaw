...
function FeaturePreview({
  ...
  return (
      ...
      <div className="order-2 rounded-[2.08rem] border border-[rgba(216,223,232,0.98)] bg-[linear-gradient(180deg,#fefcf9_0%,#eef3f8_100%)] p-[1.28rem] shadow-[0_20px_42px_rgba(15,23,42,0.098)] sm:p-[1.42rem]" data-testid="feature-preview-card">
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[0.32rem] w-full max-w-[352px] sm:max-w-[364px] lg:-mt-[4.18rem] lg:max-w-[624px] xl:-mt-[4.36rem] xl:max-w-[640px]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[276px] rounded-[1rem] border border-[rgba(234,240,246,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.998)_0%,rgba(251,246,240,0.9)_100%)] px-[0.34rem] py-[0.38rem] shadow-[0_5px_12px_rgba(15,23,42,0.02),0_2px_6px_rgba(241,180,135,0.008)] backdrop-blur-[0.5px] sm:px-[0.38rem] sm:py-[0.42rem] lg:max-w-[612px] xl:max-w-[628px]"
    >
      <div className="mx-auto w-full max-w-[308px] lg:max-w-[612px] xl:max-w-[628px]">
