...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[0.24rem] w-full max-w-[352px] sm:max-w-[364px] lg:-mt-[2.52rem] lg:max-w-[624px] xl:-mt-[2.68rem] xl:max-w-[640px]">
