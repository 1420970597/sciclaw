...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[1.86rem] w-full max-w-[168px] sm:max-w-[180px] lg:ml-auto lg:mr-[0.01rem] lg:-mt-[14.72rem] lg:max-w-[216px] xl:mr-[0.12rem] xl:-mt-[14.96rem] xl:max-w-[236px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.68rem] sm:mt-[3.1rem] lg:mt-[5.82rem] xl:mt-[6.2rem]">
        <div className="mb-[2.3rem] flex flex-col items-center gap-2.5 text-center">
