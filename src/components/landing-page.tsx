...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[1.62rem] w-full max-w-[332px] sm:max-w-[344px] lg:-mt-[8.9rem] lg:max-w-[576px] xl:-mt-[9.2rem] xl:max-w-[592px]">
