...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[1.42rem] w-full max-w-[340px] sm:max-w-[352px] lg:-mt-[8.22rem] lg:max-w-[592px] xl:-mt-[8.52rem] xl:max-w-[608px]">
