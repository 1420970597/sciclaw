...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[47.85%] top-[14.05%] sm:left-[47.85%] sm:top-[14.05%]",
      lineClass: "left-[47.72%] top-[28.85%] h-[2.18px] w-[11.9%] origin-left -rotate-[15deg]",
      ...
      labelClass: "max-w-[112px] text-left text-[#314d61] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[112px] text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-[-2.18rem] top-[0.16rem] sm:left-[-2.26rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      position: "left-[47.8%] top-[47.7%] sm:left-[47.8%] sm:top-[47.7%]",
      lineClass: "left-[47.62%] top-[51.28%] h-[2.18px] w-[11.7%] origin-left rotate-[8deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[112px] text-center text-[#314d61] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[112px] text-center text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%+0.08rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      position: "right-[14.9%] top-[12.95%] sm:right-[14.9%] sm:top-[12.95%]",
      lineClass: "left-[47.92%] top-[28.4%] h-[2.18px] w-[11.7%] origin-left rotate-[13deg]",
      ringClass: "h-[4.96rem] w-[4.96rem] border-[#466275] bg-[linear-gradient(180deg,#ffffff_0%,#f8fbfd_100%)] text-[#153446] shadow-[0_14px_24px_rgba(15,23,42,0.095)]",
      activeRingClass: "h-[5.02rem] w-[5.02rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#9f5628] shadow-[0_0_0_2px_rgba(240,142,79,0.035),0_13px_24px_rgba(232,124,55,0.082)]",
      wrapperClass: "items-center",
      labelClass: "max-w-none whitespace-nowrap text-left text-[#314d61] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-none whitespace-nowrap text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.014)]",
      labelPositionClass: "absolute left-[2.9rem] top-1/2 -translate-y-1/2 sm:left-[3.02rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      <div className="flex flex-col gap-[1.08rem] lg:grid lg:grid-cols-[minmax(0,1fr)_228px] lg:items-start lg:gap-x-[0.02rem] lg:gap-y-[0.72rem] xl:grid-cols-[minmax(0,1fr)_228px] xl:gap-x-[0.06rem] xl:gap-y-[0.8rem]">
      ...
      <div className="order-3 -mt-[0.02rem] lg:order-2 lg:col-start-2 lg:row-start-2 lg:-ml-[0.12rem] lg:ml-auto lg:mt-[0.32rem] lg:max-w-[14.2rem] xl:-ml-[0.08rem] xl:mt-[0.4rem]">
...
function AuthCard({
  ...
  return (
    <div
      ...
      className="mx-auto w-full max-w-[218px] rounded-[1rem] border border-[rgba(244,247,250,0.98)] bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(252,248,243,0.928)_100%)] px-[0.3rem] py-[0.34rem] shadow-[0_2px_5px_rgba(15,23,42,0.01),0_1px_2px_rgba(241,180,135,0.004)] backdrop-blur-[0.54px] sm:px-[0.34rem] sm:py-[0.38rem]"
    >
      <div className="mx-auto w-full max-w-[260px]">
        <div className="rounded-[0.98rem] border border-[rgba(252,252,253,0.9)] bg-[linear-gradient(180deg,rgba(255,255,255,0.95)_0%,rgba(250,245,238,0.76)_100%)] p-[0.34rem] shadow-[0_5px_12px_rgba(15,23,42,0.012)]">
          <div role="tablist" className="grid grid-cols-2 rounded-[0.72rem] bg-[rgba(247,241,234,0.78)] p-[0.26rem] text-sm text-[#6b7480]">
            {[
        ...
        <div className="mt-3.5 space-y-[1.08rem]">
          <div
            ...
            className="rounded-[1.12rem] border border-[rgba(244,247,250,0.93)] bg-[linear-gradient(180deg,rgba(255,255,255,0.978)_0%,rgba(251,247,241,0.89)_100%)] p-[0.72rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_6px_14px_rgba(15,23,42,0.014)] sm:p-[0.76rem]"
          >
            {activeMode === "onboard" ? (
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pb-16 pt-4 sm:px-8 sm:pt-5 lg:px-10 lg:pt-6">
        <div className="space-y-5 text-center sm:space-y-6">
          ...
          <div className="grid gap-3 sm:gap-[0.82rem] lg:-mt-[2.12rem]" data-testid="landing-hero">
            <FeatureRotator
