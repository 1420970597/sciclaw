...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[2.08rem] w-full max-w-[316px] sm:max-w-[328px] lg:-mt-[9.52rem] lg:max-w-[532px] xl:-mt-[9.84rem] xl:max-w-[548px]">
