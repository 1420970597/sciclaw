...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      position: "left-[49%] top-[13.4%] sm:left-[49%] sm:top-[13.4%]",
      lineClass: "left-[48.5%] top-[27.9%] h-[2.02px] w-[10.1%] origin-left -rotate-[6deg]",
      ...
      labelClass: "max-w-[124px] whitespace-nowrap text-left text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[124px] whitespace-nowrap text-left text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
      labelPositionClass: "absolute left-[-2.1rem] top-[0.42rem] sm:left-[-2.16rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      activeRingClass: "h-[4.74rem] w-[4.74rem] border-[#cf884f] bg-[linear-gradient(180deg,#fffdf9_0%,#ffe7d3_100%)] text-[#a45a2c] shadow-[0_0_0_2px_rgba(240,142,79,0.03),0_11px_20px_rgba(232,124,55,0.075)]",
      wrapperClass: "items-center",
      labelClass: "max-w-[126px] whitespace-nowrap text-center text-[#3d5869] drop-shadow-[0_1px_0_rgba(255,255,255,0.96)]",
      activeLabelClass: "max-w-[126px] whitespace-nowrap text-center text-[#5f381d] drop-shadow-[0_2px_3px_rgba(240,142,79,0.012)]",
      labelPositionClass: "absolute left-1/2 top-[calc(100%-0.28rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.14rem] w-full max-w-[284px] sm:max-w-[296px] lg:ml-auto lg:mr-[0.36rem] lg:-mt-[11.82rem] lg:max-w-[420px] xl:mr-[0.38rem] xl:-mt-[12.16rem] xl:max-w-[436px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.08rem] sm:mt-[2.48rem] lg:mt-[5.16rem] xl:mt-[5.52rem]">
