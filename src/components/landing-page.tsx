...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      icon: "文",
      position: "left-[48.6%] top-[14.2%] sm:left-[48.6%] sm:top-[14.2%]",
      lineClass: "left-[49.34%] top-[28.84%] h-[2.18px] w-[11.64%] origin-left -rotate-[24deg]",
      ...
      labelClass: "max-w-[198px] text-[#5f7989] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[168px] text-[#7f3c13] drop-shadow-[0_2px_4px_rgba(240,142,79,0.028)]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      icon: "数",
      position: "left-[49.25%] top-[47.24%] sm:left-[49.25%] sm:top-[47.24%]",
      lineClass: "left-[49.36%] top-[52.38%] h-[2.18px] w-[11.72%] origin-left rotate-[14deg]",
      ringClass: "h-[4.86rem] w-[4.86rem] border-[#466273] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_13px_21px_rgba(15,23,42,0.098)]",
      activeRingClass: "h-[4.96rem] w-[4.96rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.064),0_15px_26px_rgba(232,124,55,0.102)]",
      labelClass: "max-w-[198px] text-[#5f7989] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[168px] text-[#7f3c13] drop-shadow-[0_2px_4px_rgba(240,142,79,0.028)]",
    },
    {
      ...
      icon: "果",
      position: "right-[16.55%] top-[12.92%] sm:right-[16.55%] sm:top-[12.92%]",
      lineClass: "left-[49.32%] top-[28.94%] h-[2.18px] w-[11.46%] origin-left rotate-[22deg]",
      ringClass: "h-[4.86rem] w-[4.86rem] border-[#466273] bg-[linear-gradient(180deg,#ffffff_0%,#f7fafc_100%)] text-[#173245] shadow-[0_13px_21px_rgba(15,23,42,0.098)]",
      activeRingClass: "h-[4.96rem] w-[4.96rem] border-[#dc8d51] bg-[linear-gradient(180deg,#fffdf9_0%,#ffd9bf_100%)] text-[#ab5018] shadow-[0_0_0_3px_rgba(240,142,79,0.064),0_15px_26px_rgba(232,124,55,0.102)]",
      labelClass: "max-w-[198px] text-[#5f7989] drop-shadow-[0_1px_0_rgba(255,255,255,0.98)]",
      activeLabelClass: "max-w-[168px] text-[#7f3c13] drop-shadow-[0_2px_4px_rgba(240,142,79,0.028)]",
          ...
          return (
            <div key={node.id}>
              ...
              <button
                ...
                className={`absolute ${node.position} flex flex-col items-center gap-[0.92rem] text-center transition hover:scale-[1.02]`}
              >
                ...
                <span className={`text-[11.2px] font-medium leading-[2.16] tracking-[0.048em] sm:text-[0.81rem] ${isActive ? node.activeLabelClass : node.labelClass}`}>{node.label}</span>
              </button>
            </div>
          );
        })}
          ...
          <div className="mt-[1.36rem] grid gap-[1.42rem] lg:grid-cols-[1fr_1.05fr]">
            ...
            <div className="rounded-[1.35rem] border border-[#f0e4d8] bg-white/80 p-[1.28rem] shadow-[inset_0_1px_0_rgba(255,255,255,0.62)]">
              <div className="space-y-[1.46rem]">
                ...
                <div className="mt-[3.76rem] grid grid-cols-4 gap-[4.38rem] px-[0.46rem] pt-[4.28rem] sm:gap-[4.56rem]">
