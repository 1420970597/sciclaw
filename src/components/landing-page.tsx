...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    ...
    },
    {
      ...
      labelPositionClass: "absolute left-[1.62rem] top-[0.38rem] sm:left-[1.7rem]",
    },
    ],
    [],
  );
...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2.08rem] w-full max-w-[316px] sm:max-w-[328px] lg:ml-auto lg:mr-[0.12rem] lg:-mt-[10.42rem] lg:max-w-[496px] xl:mr-[0.14rem] xl:-mt-[10.76rem] xl:max-w-[512px]"
      >
