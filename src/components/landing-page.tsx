...
function FeatureNetwork({ activeIndex, onSelect }: { activeIndex: number; onSelect: (index: number) => void }) {
  const nodes = useMemo(
    () => [
    {
      ...
      labelPositionClass: "absolute left-[-1.66rem] top-[0.04rem] sm:left-[-1.74rem]",
    },
    {
      id: "data-mining",
      label: "Data Mining",
      ...
      labelPositionClass: "absolute left-1/2 top-[calc(100%-0.1rem)] -translate-x-1/2",
    },
    {
      id: "outcome-present",
      ...
      labelPositionClass: "absolute left-[2.28rem] top-[0.24rem] sm:left-[2.36rem]",
    },
    ],
    [],
  );
