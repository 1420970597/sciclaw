...
function FeaturePreview({
  ...
  return (
      ...
      <div
        ...
        className="order-3 mx-auto -mt-[2rem] w-full max-w-[176px] sm:max-w-[188px] lg:ml-auto lg:mr-[0.06rem] lg:-mt-[15.18rem] lg:max-w-[230px] xl:mr-[0.2rem] xl:-mt-[15.46rem] xl:max-w-[250px]"
      >
...
function BestCases({
  ...
  return (
      <section data-testid="best-cases-section" className="mt-[2.52rem] sm:mt-[2.96rem] lg:mt-[5.56rem] xl:mt-[5.92rem]">
        <div className="mb-[2.18rem] flex flex-col items-center gap-2.5 text-center">
