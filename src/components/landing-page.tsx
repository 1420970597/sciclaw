...
function FeaturePreview({
  ...
  return (
      ...
      <div data-testid="feature-auth-wrapper" className="order-3 mx-auto -mt-[2.32rem] w-full max-w-[320px] sm:max-w-[332px] lg:-mt-[9.74rem] lg:max-w-[548px] xl:-mt-[10.08rem] xl:max-w-[564px]">
