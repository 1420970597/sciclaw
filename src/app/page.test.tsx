...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_280px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.16rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.095fr)_280px]");
    expect(hero).toHaveClass("xl:gap-[0.26rem]");
    expect(authCard).toHaveClass("max-w-[268px]");
    expect(authCard).toHaveClass("bg-[#fcfdff]");
    expect(authCard).toHaveClass("border-[#f4f6f8]");
    expect(authCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.017),0_2px_5px_rgba(241,180,135,0.01)]");
    expect(authCard).toHaveClass("lg:mt-[2.44rem]");
