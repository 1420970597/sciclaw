...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[304px]");
    expect(authColumn).toHaveClass("sm:max-w-[316px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.22rem]");
    expect(authColumn).toHaveClass("lg:-mt-[10.5rem]");
    expect(authColumn).toHaveClass("lg:max-w-[464px]");
    expect(authColumn).toHaveClass("xl:mr-[0.24rem]");
    expect(authColumn).toHaveClass("xl:-mt-[10.82rem]");
    expect(authColumn).toHaveClass("xl:max-w-[480px]");
