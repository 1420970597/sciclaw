...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[2.44rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[276px]");
    expect(authColumn).toHaveClass("sm:max-w-[288px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.4rem]");
    expect(authColumn).toHaveClass("lg:-mt-[12.3rem]");
    expect(authColumn).toHaveClass("lg:max-w-[404px]");
    expect(authColumn).toHaveClass("xl:mr-[0.42rem]");
    expect(authColumn).toHaveClass("xl:-mt-[12.64rem]");
    expect(authColumn).toHaveClass("xl:max-w-[420px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[412px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[428px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[12.4rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.06rem]");
