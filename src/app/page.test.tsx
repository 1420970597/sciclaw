...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("xl:gap-x-[0.06rem]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[48.85%]");
    expect(dataMiningNode.parentElement?.className).toContain("left-[48.7%]");
    expect(outcomeNode.parentElement?.className).toContain("right-[15.6%]");
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.35%]']")).not.toBeNull();
    expect(dataMiningNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.2%]']")).not.toBeNull();
    expect(outcomeNodeWrapper?.parentElement?.querySelector("span[class*='top-[28.72%]'][class*='w-[10.3%]'][class*='rotate-[12deg]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.58rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.16rem]");
    expect(literatureNodeLabel).toHaveClass("text-left");
    expect(literatureNodeLabel).toHaveClass("text-[#5f381d]");
    expect(dataMiningNodeLabel).toHaveClass("max-w-[104px]");
    ...
    expect(dataMiningNodeLabel).toHaveClass("top-[calc(100%-0.06rem)]");
    ...
    expect(outcomeNodeLabel).toHaveClass("left-[2.22rem]");
