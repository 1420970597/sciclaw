...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[5.64rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[6rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[2.56rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[272px]");
    expect(authColumn).toHaveClass("sm:max-w-[284px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.44rem]");
    expect(authColumn).toHaveClass("lg:-mt-[12.82rem]");
    expect(authColumn).toHaveClass("lg:max-w-[396px]");
    expect(authColumn).toHaveClass("xl:mr-[0.46rem]");
    expect(authColumn).toHaveClass("xl:-mt-[13.16rem]");
    expect(authColumn).toHaveClass("xl:max-w-[412px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[404px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[420px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[12.88rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.54rem]");
    ...
    expect(authCard).toHaveClass("max-w-[248px]");
    expect(authCard).toHaveClass("lg:max-w-[576px]");
    expect(authCard).toHaveClass("xl:max-w-[592px]");
    expect(authCard).toHaveClass("rounded-[0.88rem]");
    expect(authCard).toHaveClass("border-[rgba(246,248,251,0.95)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.68)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.007),0_1px_2px_rgba(241,180,135,0.0018)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.14px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[282px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[584px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[600px]");
