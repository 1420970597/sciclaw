...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_218px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.02rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.64rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_218px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.04rem]");
    expect(featurePreview).toHaveClass("xl:gap-y-[0.72rem]");
    ...
    expect(authColumn).toHaveClass("lg:max-w-[14.12rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.03rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.24rem]");
