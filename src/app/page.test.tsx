...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(screen.getByRole("heading", { name: /best\s*cases/i }).closest("section")).toHaveClass("mt-[1.24rem]");
    expect(screen.getByRole("heading", { name: /best\s*cases/i }).closest("section")).toHaveClass("sm:mt-[1.64rem]");
    ...
    expect(hero).toHaveClass("lg:-mt-[1.94rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[0.94rem]");
    ...
    expect(authColumn).toHaveClass("lg:-mt-[5.94rem]");
    expect(authColumn).toHaveClass("lg:max-w-[592px]");
    expect(authColumn).toHaveClass("xl:-mt-[6.22rem]");
    expect(authColumn).toHaveClass("xl:max-w-[608px]");
    ...
    expect(authCard).toHaveClass("max-w-[262px]");
    expect(authCard).toHaveClass("lg:max-w-[580px]");
    expect(authCard).toHaveClass("xl:max-w-[596px]");
    expect(authCard).toHaveClass("rounded-[0.98rem]");
    expect(authCard).toHaveClass("border-[rgba(239,244,248,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(250,245,239,0.84)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.014),0_2px_4px_rgba(241,180,135,0.005)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.4px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[294px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[580px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[596px]");
  ...
  it("matches the live site best-cases default slide and keeps the section vertically airy", () => {
    ...
    expect(bestCasesSection).toHaveClass("mt-[1.24rem]");
    expect(bestCasesSection).toHaveClass("sm:mt-[1.64rem]");
