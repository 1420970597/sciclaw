...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(settingsTrigger).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.012),0_3px_6px_rgba(15,23,42,0.012),inset_0_1px_0_rgba(255,255,255,0.998)]");
    ...
    expect(literatureNode).toHaveClass("left-[56.15%]");
    expect(literatureNode).toHaveClass("top-[17.3%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.8rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.8rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.058),0_18px_30px_rgba(232,124,55,0.09)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#8a4215]");
    expect(dataMiningNode).toHaveClass("left-[56.25%]");
    expect(dataMiningNode).toHaveClass("top-[44.9%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.72rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.72rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#51697d]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#173245]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_18px_30px_rgba(15,23,42,0.118)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#27485f]");
    expect(outcomeNode).toHaveClass("right-[27.9%]");
    expect(outcomeNode).toHaveClass("top-[17.25%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.72rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.72rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#51697d]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#173245]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_18px_30px_rgba(15,23,42,0.118)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#27485f]");
