...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("max-w-[120px]");
    ...
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("sm:left-[-1.8rem]");
    expect(screen.getByText(/^data mining$/i)).toHaveClass("max-w-[122px]");
    expect(screen.getByText(/^data mining$/i)).toHaveClass("top-[calc(100%-0.18rem)]");
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("max-w-[118px]");
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("left-[1.52rem]");
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("top-[0.28rem]");
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("sm:left-[1.62rem]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNodeLabel).toHaveClass("max-w-[120px]");
    ...
    expect(literatureNodeLabel).toHaveClass("sm:left-[-1.8rem]");
    expect(literatureNodeLabel).toHaveClass("text-left");
    expect(literatureNodeLabel).toHaveClass("text-[#5f381d]");
    expect(dataMiningNodeLabel).toHaveClass("max-w-[122px]");
    ...
    expect(dataMiningNodeLabel).toHaveClass("top-[calc(100%-0.18rem)]");
    expect(dataMiningNodeLabel).toHaveClass("text-[#3d5869]");
    expect(outcomeNodeLabel).toHaveClass("max-w-[118px]");
    expect(outcomeNodeLabel).toHaveClass("whitespace-nowrap");
    expect(outcomeNodeLabel).toHaveClass("left-[1.52rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("sm:left-[1.62rem]");
