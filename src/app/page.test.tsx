...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[12.54rem]");
    expect(authColumn).toHaveClass("lg:max-w-[396px]");
    expect(authColumn).toHaveClass("xl:mr-[0.46rem]");
    expect(authColumn).toHaveClass("xl:-mt-[12.88rem]");
    ...
    expect(authColumn).not.toHaveClass("xl:-mt-[12.64rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.3rem]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.92rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.34rem]");
    expect(literatureNodeLabel).toHaveClass("sm:left-[-1.98rem]");
