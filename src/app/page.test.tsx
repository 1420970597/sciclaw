...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_248px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-0");
    expect(hero).toHaveClass("xl:-mt-[3.16rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.12fr)_248px]");
    expect(hero).toHaveClass("xl:gap-[0.02rem]");
    expect(authCard).toHaveClass("max-w-[248px]");
    expect(authCard).toHaveClass("bg-[#fdfdff]");
    expect(authCard).toHaveClass("border-[#f5f8fb]");
    expect(authCard).toHaveClass("shadow-[0_1px_3px_rgba(15,23,42,0.008),0_1px_2px_rgba(241,180,135,0.004)]");
    expect(authCard).toHaveClass("lg:mt-[1.92rem]");
    expect(authCard).toHaveClass("xl:mt-[2.1rem]");
