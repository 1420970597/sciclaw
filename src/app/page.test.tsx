...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[7.8rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[8.18rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[1.92rem]");
    ...
    expect(authColumn).toHaveClass("lg:max-w-[536px]");
    expect(authColumn).toHaveClass("xl:-mt-[9.84rem]");
    expect(authColumn).toHaveClass("xl:max-w-[552px]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[47.8%]");
    ...
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[11.2%]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.94rem]");
