...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("xl:-mt-[17.46rem]");
    ...
    expect(authColumn).not.toHaveClass("lg:mr-[0.72rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.92rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[17.18rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17.62rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[300px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[320px]");
