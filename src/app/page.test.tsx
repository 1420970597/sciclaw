...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(primaryNav).toHaveClass("gap-[0.68rem]");
    expect(primaryNav).toHaveClass("sm:gap-[0.86rem]");
    ...
    expect(literatureNode).toHaveClass("left-[57.6%]");
    expect(literatureNode).toHaveClass("top-[16.9%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.88rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.88rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.06),0_19px_32px_rgba(232,124,55,0.094)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#8a4215]");
    expect(dataMiningNode).toHaveClass("left-[57.65%]");
    expect(dataMiningNode).toHaveClass("top-[44.4%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.78rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.78rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#4d6478]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#163144]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_19px_32px_rgba(15,23,42,0.124)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#24465d]");
    expect(outcomeNode).toHaveClass("right-[24.8%]");
    expect(outcomeNode).toHaveClass("top-[16.95%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.78rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.78rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#4d6478]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#163144]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_19px_32px_rgba(15,23,42,0.124)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#24465d]");
    ...
    chartLabels.forEach((label) => {
      ...
      expect(labelWrapper).toHaveClass("text-[14.15px]");
      expect(labelWrapper).toHaveClass("tracking-[0.01em]");
      expect(labelWrapper).toHaveClass("text-[#11344d]");
      expect(label).toHaveClass("max-w-[5.52rem]");
