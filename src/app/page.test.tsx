...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[192px]");
    expect(authColumn).toHaveClass("sm:max-w-[204px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.18rem]");
    expect(authColumn).toHaveClass("lg:-mt-[15.7rem]");
    expect(authColumn).toHaveClass("lg:max-w-[248px]");
    expect(authColumn).toHaveClass("xl:mr-[0.32rem]");
    expect(authColumn).toHaveClass("xl:-mt-[15.96rem]");
    expect(authColumn).toHaveClass("xl:max-w-[268px]");
    expect(authColumn).not.toHaveClass("max-w-[198px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[210px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.22rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.36rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[15.86rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.14rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[254px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[274px]");
