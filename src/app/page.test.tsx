...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:mr-[1.62rem]");
    expect(authColumn).toHaveClass("lg:-mt-[15.42rem]");
    expect(authColumn).toHaveClass("lg:max-w-[376px]");
    expect(authColumn).toHaveClass("xl:mr-[1.82rem]");
    expect(authColumn).toHaveClass("xl:-mt-[15.78rem]");
    expect(authColumn).toHaveClass("xl:max-w-[392px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.42rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.58rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[15.18rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[15.52rem]");
