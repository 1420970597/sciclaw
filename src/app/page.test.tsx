...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[10.58rem]");
    expect(authColumn).toHaveClass("lg:max-w-[440px]");
    expect(authColumn).toHaveClass("xl:mr-[0.1rem]");
    expect(authColumn).toHaveClass("xl:-mt-[10.96rem]");
    expect(authColumn).toHaveClass("xl:max-w-[456px]");
