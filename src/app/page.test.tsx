...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[1.88rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[296px]");
    expect(authColumn).toHaveClass("sm:max-w-[308px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.26rem]");
    expect(authColumn).toHaveClass("lg:-mt-[10.74rem]");
    expect(authColumn).toHaveClass("lg:max-w-[448px]");
    expect(authColumn).toHaveClass("xl:mr-[0.28rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.06rem]");
    expect(authColumn).toHaveClass("xl:max-w-[464px]");
