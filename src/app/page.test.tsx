...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[12.58rem]");
    expect(authColumn).toHaveClass("lg:max-w-[388px]");
    expect(authColumn).toHaveClass("xl:mr-[0.44rem]");
    expect(authColumn).toHaveClass("xl:-mt-[12.9rem]");
    expect(authColumn).toHaveClass("xl:max-w-[404px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[396px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[412px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[13.16rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.82rem]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[560px]");
    expect(authCard).toHaveClass("xl:max-w-[576px]");
    expect(authCard).toHaveClass("rounded-[0.88rem]");
    expect(authCard).toHaveClass("border-[rgba(247,249,252,0.94)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(251,246,240,0.64)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.006),0_1px_2px_rgba(241,180,135,0.0015)]");
