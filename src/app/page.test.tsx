...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(networkShellFrame).toHaveClass("lg:-mt-[2.08rem]");
    expect(networkShellFrame).toHaveClass("lg:-mr-[0.04rem]");
    expect(networkShellFrame).toHaveClass("xl:-mt-[2.3rem]");
    expect(networkShellFrame).toHaveClass("xl:-mr-[0.1rem]");
    ...
    expect(hero).toHaveClass("lg:-mt-[1.86rem]");
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_200px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.1rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.9rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_200px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.16rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[0.14rem]");
    expect(authColumn).toHaveClass("lg:-ml-[0.04rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.06rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.1rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.14rem]");
    ...
    expect(authCard).toHaveClass("max-w-[190px]");
    expect(authCard).toHaveClass("rounded-[1.1rem]");
    expect(authCard).toHaveClass("border-[rgba(243,246,249,0.97)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(251,247,242,0.948)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.022),0_1px_3px_rgba(241,180,135,0.011)]");
    expect(authCard).toHaveClass("backdrop-blur-[1px]");
    ...
    expect(previewLabelRow).toHaveClass("mt-[2.54rem]");
    expect(previewLabelRow).toHaveClass("gap-[3.18rem]");
    expect(previewLabelRow).toHaveClass("pt-[2.38rem]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    chartLabels.forEach((label) => {
      ...
      expect(label).toHaveClass("max-w-[6.48rem]");
    ...
    expect(chartRow).toHaveClass("gap-[3.18rem]");
    expect(chartRow).toHaveClass("sm:gap-[3.32rem]");
    expect(chartRow).toHaveClass("mt-[2.54rem]");
    expect(chartRow).toHaveClass("pt-[2.38rem]");
    ...
    expect(literatureNodeLabel).toHaveClass("max-w-[96px]");
    expect(literatureNodeLabel).toHaveClass("left-[-3.08rem]");
    ...
    expect(dataMiningNodeLabel).toHaveClass("max-w-[96px]");
    ...
    expect(dataMiningNodeLabel).toHaveClass("top-[calc(100%+0.5rem)]");
    expect(dataMiningNodeLabel).toHaveClass("text-[#314d61]");
    expect(outcomeNodeLabel).toHaveClass("max-w-[96px]");
    expect(outcomeNodeLabel).toHaveClass("left-[3.28rem]");
