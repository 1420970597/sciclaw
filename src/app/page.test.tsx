...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:gap-x-[0.01rem]");
    ...
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,247,242,0.93)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.014),0_1px_2px_rgba(241,180,135,0.007)]");
