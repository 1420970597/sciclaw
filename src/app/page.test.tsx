...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_254px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.04rem]");
    expect(hero).toHaveClass("xl:-mt-[3.16rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.12fr)_254px]");
    ...
    expect(authCard).toHaveClass("xl:mt-[3.08rem]");
