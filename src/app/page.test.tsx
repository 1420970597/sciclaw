...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_214px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.22rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.9rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_214px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.28rem]");
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.01rem]");
    ...
    expect(authCard).toHaveClass("rounded-[1.18rem]");
    expect(authCard).toHaveClass("border-[rgba(240,244,248,0.96)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(250,246,241,0.958)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.03),0_1px_4px_rgba(241,180,135,0.015)]");
    expect(authCard).toHaveClass("backdrop-blur-[1.5px]");
