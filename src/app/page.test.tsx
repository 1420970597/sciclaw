...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(networkShellFrame).toHaveClass("lg:-mt-[2.18rem]");
    expect(networkShellFrame).toHaveClass("lg:mr-0");
    expect(networkShellFrame).toHaveClass("xl:-mt-[2.38rem]");
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[6.08rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[6.42rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[2.32rem]");
    ...
    expect(authColumn).toHaveClass("lg:mr-[0.08rem]");
    expect(authColumn).toHaveClass("lg:-mt-[10.72rem]");
    expect(authColumn).toHaveClass("lg:max-w-[500px]");
    expect(authColumn).toHaveClass("xl:mr-[0.1rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.08rem]");
    expect(authColumn).toHaveClass("xl:max-w-[516px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[440px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[456px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[8.92rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[8.58rem]");
    ...
    expect(authCard).toHaveClass("max-w-[252px]");
    expect(authCard).toHaveClass("lg:max-w-[584px]");
    expect(authCard).toHaveClass("xl:max-w-[600px]");
    expect(authCard).toHaveClass("rounded-[0.9rem]");
    expect(authCard).toHaveClass("border-[rgba(244,247,250,0.95)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.74)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_3px_rgba(15,23,42,0.008),0_1px_2px_rgba(241,180,135,0.002)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.18px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[592px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[608px]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[48.6%]");
    expect(dataMiningNode.parentElement?.className).toContain("left-[49.02%]");
    expect(outcomeNode.parentElement?.className).toContain("right-[17.9%]");
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.8%]']")).not.toBeNull();
    expect(dataMiningNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.52%]']")).not.toBeNull();
    expect(outcomeNodeWrapper?.parentElement?.querySelector("span[class*='top-[27.92%]'][class*='w-[10.74%]'][class*='rotate-[11deg]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("max-w-[104px]");
    expect(literatureNodeLabel).toHaveClass("left-[-1.66rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.04rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("left-[2.66rem]");
    expect(outcomeNodeLabel).toHaveClass("top-[-0.02rem]");
