...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(networkShellFrame).toHaveClass("lg:-mr-[0.02rem]");
    expect(networkShellFrame).toHaveClass("xl:-mt-[2.42rem]");
    expect(networkShellFrame).toHaveClass("xl:-mr-[0.08rem]");
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_196px]");
    ...
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_196px]");
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.16rem]");
    ...
    expect(authColumn).toHaveClass("xl:-ml-[0.22rem]");
    ...
    expect(authCard).toHaveClass("max-w-[186px]");
    expect(authCard).toHaveClass("rounded-[1.08rem]");
    expect(authCard).toHaveClass("border-[rgba(244,247,250,0.97)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,247,242,0.94)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_5px_rgba(15,23,42,0.018),0_1px_2px_rgba(241,180,135,0.009)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.8px]");
