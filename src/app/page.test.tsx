...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:mr-[0.62rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.84rem]");
    expect(authColumn).toHaveClass("lg:max-w-[304px]");
    expect(authColumn).toHaveClass("xl:mr-[0.82rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.2rem]");
    expect(authColumn).toHaveClass("xl:max-w-[324px]");
    expect(authColumn).not.toHaveClass("max-w-[228px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[240px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.48rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.64rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[17.02rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17.42rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[292px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[312px]");
