...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[198px]");
    expect(authColumn).toHaveClass("sm:max-w-[210px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.22rem]");
    expect(authColumn).toHaveClass("lg:-mt-[15.86rem]");
    expect(authColumn).toHaveClass("lg:max-w-[254px]");
    expect(authColumn).toHaveClass("xl:mr-[0.36rem]");
    expect(authColumn).toHaveClass("xl:-mt-[16.14rem]");
    expect(authColumn).toHaveClass("xl:max-w-[274px]");
    expect(authColumn).not.toHaveClass("max-w-[206px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[218px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.28rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.44rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.08rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.38rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[262px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[282px]");
