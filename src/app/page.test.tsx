...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[5.32rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[5.64rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[2.18rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[232px]");
    expect(authColumn).toHaveClass("sm:max-w-[244px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.72rem]");
    expect(authColumn).toHaveClass("lg:-mt-[17.22rem]");
    expect(authColumn).toHaveClass("lg:max-w-[300px]");
    expect(authColumn).toHaveClass("xl:mr-[0.92rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.68rem]");
    expect(authColumn).toHaveClass("xl:max-w-[320px]");
    expect(authColumn).not.toHaveClass("max-w-[240px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[252px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.08rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.32rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[18.08rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[18.5rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[312px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[332px]");
    ...
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("left-[-1.96rem]");
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("top-[0.34rem]");
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("sm:left-[-2.04rem]");
    ...
    expect(authCard).toHaveClass("max-w-[212px]");
    ...
    expect(authCard).toHaveClass("border-[rgba(226,232,239,0.94)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.986)_0%,rgba(249,245,239,0.82)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_10px_22px_rgba(15,23,42,0.04),0_3px_7px_rgba(241,180,135,0.042)]");
    ...
    expect(authCard).not.toHaveClass("max-w-[220px]");
    expect(authCard).not.toHaveClass("lg:max-w-[480px]");
    expect(authCard).not.toHaveClass("xl:max-w-[496px]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[43.1%]");
    expect(dataMiningNode.parentElement?.className).toContain("left-[42.9%]");
    expect(outcomeNode.parentElement?.className).toContain("right-[14.2%]");
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[15.6%]']")).not.toBeNull();
    expect(dataMiningNodeWrapper?.parentElement?.querySelector("span[class*='w-[16.2%]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.96rem]");
