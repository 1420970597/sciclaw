...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[260px]");
    expect(authColumn).toHaveClass("sm:max-w-[272px]");
    expect(authColumn).toHaveClass("lg:mt-[0.42rem]");
    ...
    expect(authCard).toHaveClass("border-[rgba(245,248,251,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(252,248,243,0.92)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_4px_rgba(15,23,42,0.008),0_1px_2px_rgba(241,180,135,0.003)]");
