...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[268px]");
    expect(authColumn).toHaveClass("sm:max-w-[280px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.38rem]");
    expect(authColumn).toHaveClass("lg:-mt-[12.84rem]");
    expect(authColumn).toHaveClass("lg:max-w-[380px]");
    expect(authColumn).toHaveClass("xl:mr-[0.4rem]");
    expect(authColumn).toHaveClass("xl:-mt-[13.14rem]");
    expect(authColumn).toHaveClass("xl:max-w-[396px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[388px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[404px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[12.9rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.58rem]");
