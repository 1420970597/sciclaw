...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:mr-[0.3rem]");
    expect(authColumn).toHaveClass("lg:-mt-[11.3rem]");
    expect(authColumn).toHaveClass("lg:max-w-[444px]");
    expect(authColumn).toHaveClass("xl:mr-[0.32rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.64rem]");
    expect(authColumn).toHaveClass("xl:max-w-[460px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[452px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[468px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[11.52rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.18rem]");
