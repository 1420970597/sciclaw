...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("mt-[1.92rem]");
    expect(bestCasesSection).toHaveClass("sm:mt-[2.28rem]");
    expect(bestCasesSection).toHaveClass("lg:mt-[4.62rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[4.92rem]");
    ...
    expect(authColumn).toHaveClass("lg:mr-[1.36rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.7rem]");
    expect(authColumn).toHaveClass("lg:max-w-[324px]");
    expect(authColumn).toHaveClass("xl:mr-[1.64rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.08rem]");
    expect(authColumn).toHaveClass("xl:max-w-[344px]");
    ...
    expect(authColumn).not.toHaveClass("lg:max-w-[336px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[356px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[500px]");
