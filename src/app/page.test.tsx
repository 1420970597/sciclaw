...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(dataMiningNode.parentElement?.className).toContain("left-[48.25%]");
    expect(outcomeNode.parentElement?.className).toContain("right-[16.2%]");
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.8%]']")).not.toBeNull();
    expect(dataMiningNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.6%]']")).not.toBeNull();
    expect(outcomeNodeWrapper?.parentElement?.querySelector("span[class*='top-[28.95%]'][class*='w-[10.7%]'][class*='rotate-[12deg]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.84rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.28rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("left-[2.46rem]");
