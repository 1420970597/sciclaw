...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[0.2rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.02rem]");
    expect(authColumn).toHaveClass("lg:max-w-[600px]");
    expect(authColumn).toHaveClass("xl:mt-[0.06rem]");
    expect(authColumn).toHaveClass("xl:max-w-[620px]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[404px]");
    expect(authCard).toHaveClass("xl:max-w-[420px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[268px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[404px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[420px]");
