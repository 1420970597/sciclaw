...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(literatureNode).toHaveClass("left-[53.85%]");
    expect(literatureNode).toHaveClass("top-[18.95%]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.058),0_17px_31px_rgba(232,124,55,0.102)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#864015]");
    expect(dataMiningNode).toHaveClass("left-[53.95%]");
    expect(dataMiningNode).toHaveClass("top-[47.75%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.38rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.38rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#48647a]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#1c3648]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_16px_30px_rgba(15,23,42,0.118)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#244456]");
    expect(outcomeNode).toHaveClass("right-[33.75%]");
    expect(outcomeNode).toHaveClass("top-[18.95%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.38rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.38rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#48647a]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#1c3648]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_16px_30px_rgba(15,23,42,0.118)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#244456]");
