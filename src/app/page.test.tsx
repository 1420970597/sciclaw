...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[300px]");
    expect(authColumn).toHaveClass("sm:max-w-[312px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.28rem]");
    expect(authColumn).toHaveClass("lg:-mt-[11.18rem]");
    expect(authColumn).toHaveClass("lg:max-w-[452px]");
    expect(authColumn).toHaveClass("xl:mr-[0.3rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.52rem]");
    expect(authColumn).toHaveClass("xl:max-w-[468px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[440px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[456px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[11.18rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[10.86rem]");
