...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:mr-[0.24rem]");
    expect(authColumn).toHaveClass("lg:-mt-[10.62rem]");
    expect(authColumn).toHaveClass("lg:max-w-[456px]");
    expect(authColumn).toHaveClass("xl:mr-[0.26rem]");
    expect(authColumn).toHaveClass("xl:-mt-[10.94rem]");
