...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_296px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.5rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.07fr)_296px]");
    expect(hero).toHaveClass("xl:gap-[0.68rem]");
    expect(authCard).toHaveClass("max-w-[286px]");
    expect(authCard).toHaveClass("bg-white");
    expect(authCard).toHaveClass("border-[#ebeff4]");
    expect(authCard).toHaveClass("shadow-[0_10px_24px_rgba(15,23,42,0.032),0_3px_10px_rgba(241,180,135,0.022)]");
    expect(authCard).toHaveClass("lg:mt-[2.42rem]");
    expect(authCard).toHaveClass("xl:mt-[2.68rem]");
