...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[4.98rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[5.28rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[2.88rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[244px]");
    expect(authColumn).toHaveClass("sm:max-w-[256px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[1.48rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.7rem]");
    expect(authColumn).toHaveClass("lg:max-w-[336px]");
    expect(authColumn).toHaveClass("xl:mr-[1.78rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.08rem]");
    expect(authColumn).toHaveClass("xl:max-w-[356px]");
    expect(authColumn).not.toHaveClass("max-w-[248px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[260px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.44rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.72rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.62rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[352px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[372px]");
    ...
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("left-[-1.88rem]");
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("top-[0.46rem]");
    expect(screen.getByText(/^literature analysis$/i)).toHaveClass("sm:left-[-1.94rem]");
    ...
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("top-[0.36rem]");
    expect(screen.getByText(/^outcome present$/i)).toHaveClass("sm:left-[1.88rem]");
    ...
    expect(authCard).toHaveClass("max-w-[220px]");
    expect(authCard).toHaveClass("lg:max-w-[492px]");
    expect(authCard).toHaveClass("xl:max-w-[508px]");
    expect(authCard).toHaveClass("rounded-[0.74rem]");
    expect(authCard).toHaveClass("border-[rgba(247,249,252,0.74)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.958)_0%,rgba(249,244,237,0.38)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.0018),0_1px_2px_rgba(241,180,135,0.00038)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.05px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[252px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[496px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[512px]");
    expect(authCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.78rem]");
    expect(authCard).not.toHaveClass("max-w-[224px]");
    expect(authCard).not.toHaveClass("lg:max-w-[508px]");
    expect(authCard).not.toHaveClass("xl:max-w-[524px]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-1.88rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.46rem]");
    expect(literatureNodeLabel).toHaveClass("sm:left-[-1.94rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("top-[0.36rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("sm:left-[1.88rem]");
