...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_232px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.1rem]");
    expect(hero).toHaveClass("xl:-mt-[2.28rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.08fr)_232px]");
    expect(hero).toHaveClass("xl:gap-[0.14rem]");
    ...
    expect(authCard).toHaveClass("lg:mt-[2.16rem]");
    expect(authCard).toHaveClass("xl:mt-[2.3rem]");
