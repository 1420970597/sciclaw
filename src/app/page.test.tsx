...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_232px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.42rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.94rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_232px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.5rem]");
