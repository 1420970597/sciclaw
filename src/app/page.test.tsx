...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[5.72rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[6.06rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[2.14rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[284px]");
    expect(authColumn).toHaveClass("sm:max-w-[296px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.36rem]");
    expect(authColumn).toHaveClass("lg:-mt-[11.82rem]");
    expect(authColumn).toHaveClass("lg:max-w-[420px]");
    expect(authColumn).toHaveClass("xl:mr-[0.38rem]");
    expect(authColumn).toHaveClass("xl:-mt-[12.16rem]");
    expect(authColumn).toHaveClass("xl:max-w-[436px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[428px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[444px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[12rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.66rem]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[49%]");
    ...
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.1%]']")).not.toBeNull();
