...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[344px]");
    expect(authColumn).toHaveClass("sm:max-w-[356px]");
    expect(authColumn).toHaveClass("lg:-mt-[5.9rem]");
    expect(authColumn).toHaveClass("lg:max-w-[600px]");
    expect(authColumn).toHaveClass("xl:-mt-[6.18rem]");
