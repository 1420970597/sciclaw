...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[16.58rem]");
    expect(authColumn).toHaveClass("lg:max-w-[360px]");
    expect(authColumn).toHaveClass("xl:mr-[1.68rem]");
    expect(authColumn).toHaveClass("xl:-mt-[16.96rem]");
    expect(authColumn).toHaveClass("xl:max-w-[380px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.58rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.82rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.34rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.72rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[370px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[390px]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[532px]");
    expect(authCard).toHaveClass("xl:max-w-[548px]");
    expect(authCard).toHaveClass("rounded-[0.84rem]");
    expect(authCard).toHaveClass("border-[rgba(248,250,252,0.9)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.982)_0%,rgba(250,246,240,0.54)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.004),0_1px_2px_rgba(241,180,135,0.0008)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.08px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[266px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[536px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[552px]");
