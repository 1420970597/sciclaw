...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_226px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.34rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.94rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_226px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.42rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.12rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.14rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.26rem]");
    ...
    expect(authCard).toHaveClass("rounded-[1.28rem]");
    expect(authCard).toHaveClass("border-[rgba(230,235,241,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(249,245,240,0.974)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_10px_22px_rgba(15,23,42,0.058),0_2px_8px_rgba(241,180,135,0.03)]");
    expect(authCard).toHaveClass("backdrop-blur-[2px]");
