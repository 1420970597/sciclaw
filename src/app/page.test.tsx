...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(featurePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_228px]");
    expect(featurePreview).toHaveClass("lg:items-start");
    expect(featurePreview).toHaveClass("lg:gap-x-[0.08rem]");
    expect(featurePreview).toHaveClass("lg:gap-y-[0.94rem]");
    expect(featurePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_228px]");
    expect(featurePreview).toHaveClass("xl:gap-x-[0.14rem]");
    ...
    expect(authCard).toHaveClass("border-[rgba(241,245,249,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(251,247,242,0.95)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.022),0_1px_3px_rgba(241,180,135,0.01)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.88px]");
