...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[12.06rem]");
    expect(authColumn).toHaveClass("lg:max-w-[412px]");
    expect(authColumn).toHaveClass("xl:mr-[0.38rem]");
    expect(authColumn).toHaveClass("xl:-mt-[12.4rem]");
    expect(authColumn).toHaveClass("xl:max-w-[428px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[420px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[436px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[12.16rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.82rem]");
