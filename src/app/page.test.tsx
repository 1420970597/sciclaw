...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[252px]");
    expect(authColumn).toHaveClass("sm:max-w-[264px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[1.44rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.62rem]");
    expect(authColumn).toHaveClass("lg:max-w-[352px]");
    expect(authColumn).toHaveClass("xl:mr-[1.72rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17rem]");
    expect(authColumn).toHaveClass("xl:max-w-[372px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.42rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.68rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.58rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.96rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[360px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[380px]");
    ...
    expect(authCard).toHaveClass("rounded-[0.8rem]");
    expect(authCard).toHaveClass("border-[rgba(247,249,252,0.88)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.978)_0%,rgba(249,244,237,0.5)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.003),0_1px_2px_rgba(241,180,135,0.00065)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.06px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[262px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[524px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[540px]");
