...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.11fr)_272px]");
    expect(hero).toHaveClass("xl:gap-[0.18rem]");
    expect(authCard).toHaveClass("max-w-[260px]");
    expect(authCard).toHaveClass("bg-[#fcfdff]");
    expect(authCard).toHaveClass("border-[#f5f7f9]");
    expect(authCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.014),0_2px_4px_rgba(241,180,135,0.008)]");
    expect(authCard).toHaveClass("lg:mt-[2.56rem]");
    expect(authCard).toHaveClass("xl:mt-[2.76rem]");
