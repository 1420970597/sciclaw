...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(literatureNode).toHaveClass("left-[53.45%]");
    expect(literatureNode).toHaveClass("top-[18.7%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.28rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.28rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_15px_28px_rgba(232,124,55,0.095)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#864015]");
    expect(dataMiningNode).toHaveClass("left-[53.55%]");
    expect(dataMiningNode).toHaveClass("top-[48.15%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.2rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.2rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#486277]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#203949]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_14px_26px_rgba(15,23,42,0.1)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#2a4459]");
    expect(outcomeNode).toHaveClass("right-[35.55%]");
    expect(outcomeNode).toHaveClass("top-[18.85%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.2rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.2rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#486277]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#203949]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_14px_26px_rgba(15,23,42,0.1)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#2a4459]");
    ...
    chartLabels.forEach((label) => {
      ...
      expect(labelWrapper).toHaveClass("text-[12.9px]");
      expect(labelWrapper).toHaveClass("tracking-[0.006em]");
      expect(labelWrapper).toHaveClass("text-[#173d56]");
      expect(label).toHaveClass("max-w-[4.7rem]");
