...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[0.28rem]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[600px]");
    expect(authCard).toHaveClass("xl:max-w-[616px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[296px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[600px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[616px]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[49.1%]");
    ...
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[10.55%]']")).not.toBeNull();
