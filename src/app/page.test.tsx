...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[292px]");
    expect(authColumn).toHaveClass("sm:max-w-[304px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.32rem]");
    expect(authColumn).toHaveClass("lg:-mt-[11.42rem]");
    expect(authColumn).toHaveClass("lg:max-w-[436px]");
    expect(authColumn).toHaveClass("xl:mr-[0.34rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.76rem]");
    expect(authColumn).toHaveClass("xl:max-w-[452px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[444px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[460px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[11.64rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.3rem]");
