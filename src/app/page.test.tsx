...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.03rem]");
    ...
    expect(authColumn).toHaveClass("xl:mt-[0.08rem]");
    ...
    expect(authCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.026),0_1px_3px_rgba(241,180,135,0.013)]");
    expect(authCard).toHaveClass("backdrop-blur-[1.25px]");
