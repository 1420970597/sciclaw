...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_288px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.26rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.075fr)_288px]");
    expect(hero).toHaveClass("xl:gap-[0.38rem]");
    expect(authCard).toHaveClass("max-w-[278px]");
    expect(authCard).toHaveClass("bg-[#fdfdff]");
    expect(authCard).toHaveClass("border-[#f1f4f7]");
    expect(authCard).toHaveClass("shadow-[0_6px_14px_rgba(15,23,42,0.022),0_2px_7px_rgba(241,180,135,0.014)]");
    expect(authCard).toHaveClass("lg:mt-[2.42rem]");
    expect(authCard).toHaveClass("xl:mt-[2.64rem]");
