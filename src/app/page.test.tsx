...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(settingsTrigger).toHaveClass("h-[2.72rem]");
    expect(settingsTrigger).toHaveClass("w-[2.72rem]");
    expect(settingsTrigger).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.014),0_4px_8px_rgba(15,23,42,0.014),inset_0_1px_0_rgba(255,255,255,0.998)]");
    ...
    expect(primaryNav).toHaveClass("sm:gap-[0.7rem]");
    ...
    expect(literatureNode).toHaveClass("left-[56.35%]");
    expect(literatureNode).toHaveClass("top-[15.7%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.78rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.78rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.054),0_18px_30px_rgba(232,124,55,0.09)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#8a4215]");
    expect(dataMiningNode).toHaveClass("left-[56.45%]");
    expect(dataMiningNode).toHaveClass("top-[42.8%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.62rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.62rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#53697c]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#173246]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_17px_28px_rgba(15,23,42,0.112)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#315169]");
    expect(outcomeNode).toHaveClass("right-[23.4%]");
    expect(outcomeNode).toHaveClass("top-[15.8%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.62rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.62rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#53697c]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#173246]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_17px_28px_rgba(15,23,42,0.112)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#315169]");
    ...
    chartLabels.forEach((label) => {
      ...
      expect(labelWrapper).toHaveClass("text-[13.2px]");
      expect(labelWrapper).toHaveClass("tracking-[0.028em]");
      expect(labelWrapper).toHaveClass("text-[#35566d]");
      expect(label).toHaveClass("max-w-[4.72rem]");
