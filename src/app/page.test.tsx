...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[206px]");
    expect(authColumn).toHaveClass("sm:max-w-[218px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.28rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.08rem]");
    expect(authColumn).toHaveClass("lg:max-w-[262px]");
    expect(authColumn).toHaveClass("xl:mr-[0.44rem]");
    expect(authColumn).toHaveClass("xl:-mt-[16.38rem]");
    expect(authColumn).toHaveClass("xl:max-w-[282px]");
    expect(authColumn).not.toHaveClass("max-w-[210px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[222px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.3rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.48rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.26rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.58rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[266px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[286px]");
