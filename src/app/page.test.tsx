...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authCard).toHaveClass("border-[rgba(242,246,249,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,247,242,0.94)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.016),0_1px_2px_rgba(241,180,135,0.008)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.76px]");
