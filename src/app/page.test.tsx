...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).not.toHaveClass("max-w-[244px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[256px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.36rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.64rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.7rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17.08rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[324px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[344px]");
