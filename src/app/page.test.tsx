...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(literatureNode).toHaveClass("left-[54.55%]");
    expect(literatureNode).toHaveClass("top-[19.15%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.34rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.34rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.056),0_16px_29px_rgba(232,124,55,0.098)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#864015]");
    expect(dataMiningNode).toHaveClass("left-[54.65%]");
    expect(dataMiningNode).toHaveClass("top-[48.05%]");
    expect(dataMiningNode.firstElementChild).toHaveClass("h-[4.26rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("w-[4.26rem]");
    expect(dataMiningNode.firstElementChild).toHaveClass("border-[#446075]");
    expect(dataMiningNode.firstElementChild).toHaveClass("text-[#1f3849]");
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_15px_28px_rgba(15,23,42,0.112)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#284456]");
    expect(outcomeNode).toHaveClass("right-[34.4%]");
    expect(outcomeNode).toHaveClass("top-[19.2%]");
    expect(outcomeNode.firstElementChild).toHaveClass("h-[4.26rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("w-[4.26rem]");
    expect(outcomeNode.firstElementChild).toHaveClass("border-[#446075]");
    expect(outcomeNode.firstElementChild).toHaveClass("text-[#1f3849]");
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_15px_28px_rgba(15,23,42,0.112)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#284456]");
