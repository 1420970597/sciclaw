...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("xl:mt-[6.62rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[1.96rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[288px]");
    expect(authColumn).toHaveClass("sm:max-w-[300px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.34rem]");
    expect(authColumn).toHaveClass("lg:-mt-[11.54rem]");
    expect(authColumn).toHaveClass("lg:max-w-[428px]");
    expect(authColumn).toHaveClass("xl:mr-[0.36rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.88rem]");
    expect(authColumn).toHaveClass("xl:max-w-[444px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[436px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[452px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[11.76rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.42rem]");
