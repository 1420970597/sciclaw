...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[2.26rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[222px]");
    expect(authColumn).toHaveClass("sm:max-w-[234px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.42rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.92rem]");
    expect(authColumn).toHaveClass("lg:max-w-[284px]");
    expect(authColumn).toHaveClass("xl:mr-[0.62rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.24rem]");
    expect(authColumn).toHaveClass("xl:max-w-[304px]");
    ...
    expect(authColumn).not.toHaveClass("xl:mr-[0.68rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[17.18rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17.52rem]");
