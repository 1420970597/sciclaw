...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.06rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.18rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.1rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.32rem]");
    ...
    expect(authCard).toHaveClass("max-w-[216px]");
    expect(authCard).toHaveClass("rounded-[1.26rem]");
    expect(authCard).toHaveClass("border-[rgba(233,238,243,0.96)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(249,245,240,0.968)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_8px_18px_rgba(15,23,42,0.048),0_2px_6px_rgba(241,180,135,0.022)]");
