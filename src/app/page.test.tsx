...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[180px]");
    expect(authColumn).toHaveClass("sm:max-w-[192px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.1rem]");
    expect(authColumn).toHaveClass("lg:-mt-[15.34rem]");
    expect(authColumn).toHaveClass("lg:max-w-[236px]");
    expect(authColumn).toHaveClass("xl:mr-[0.24rem]");
    expect(authColumn).toHaveClass("xl:-mt-[15.62rem]");
    expect(authColumn).toHaveClass("xl:max-w-[256px]");
    expect(authColumn).not.toHaveClass("max-w-[186px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[198px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.14rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.28rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[15.52rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[15.8rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[242px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[262px]");
