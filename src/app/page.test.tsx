...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_284px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.2rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.085fr)_284px]");
    expect(hero).toHaveClass("xl:gap-[0.32rem]");
    expect(authCard).toHaveClass("max-w-[272px]");
    expect(authCard).toHaveClass("bg-[#fcfdff]");
    expect(authCard).toHaveClass("border-[#f3f5f8]");
    expect(authCard).toHaveClass("shadow-[0_5px_12px_rgba(15,23,42,0.019),0_2px_6px_rgba(241,180,135,0.012)]");
