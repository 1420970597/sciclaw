...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[308px]");
    expect(authColumn).toHaveClass("sm:max-w-[320px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.2rem]");
    expect(authColumn).toHaveClass("lg:-mt-[10.34rem]");
    expect(authColumn).toHaveClass("lg:max-w-[472px]");
    expect(authColumn).toHaveClass("xl:mr-[0.22rem]");
    expect(authColumn).toHaveClass("xl:-mt-[10.66rem]");
    expect(authColumn).toHaveClass("xl:max-w-[488px]");
