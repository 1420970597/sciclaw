...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-mt-[13.58rem]");
    expect(authColumn).toHaveClass("lg:max-w-[368px]");
    expect(authColumn).toHaveClass("xl:mr-[0.72rem]");
    expect(authColumn).toHaveClass("xl:-mt-[13.92rem]");
    expect(authColumn).toHaveClass("xl:max-w-[384px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[380px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[396px]");
    expect(authColumn).not.toHaveClass("xl:-mt-[13.14rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[12.84rem]");
