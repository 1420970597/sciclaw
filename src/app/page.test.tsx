...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authCard).toHaveClass("rounded-[1.02rem]");
    expect(authCard).toHaveClass("border-[rgba(243,246,249,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.93)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_2px_rgba(241,180,135,0.005)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.58px]");
