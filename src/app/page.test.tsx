...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.14rem]");
    ...
    expect(authCard).toHaveClass("rounded-[1.04rem]");
    expect(authCard).toHaveClass("border-[rgba(241,245,249,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.997)_0%,rgba(252,248,243,0.95)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.013),0_1px_2px_rgba(241,180,135,0.006)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.68px]");
