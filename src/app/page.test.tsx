...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-2.14rem]");
    expect(literatureNodeLabel).toHaveClass("top-[-0.14rem]");
    expect(literatureNodeLabel).toHaveClass("sm:left-[-2.2rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("left-[2.08rem]");
    expect(outcomeNodeLabel).toHaveClass("top-[0.46rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("sm:left-[2.16rem]");
