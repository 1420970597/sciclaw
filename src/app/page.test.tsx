...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[0.16rem]");
    ...
    expect(authColumn).toHaveClass("lg:max-w-[628px]");
    expect(authColumn).toHaveClass("xl:mt-[0.04rem]");
    expect(authColumn).toHaveClass("xl:max-w-[644px]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[424px]");
    expect(authCard).toHaveClass("xl:max-w-[438px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[276px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[424px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[438px]");
