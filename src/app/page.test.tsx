...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("lg:mt-[4.92rem]");
    ...
    expect(authColumn).toHaveClass("max-w-[248px]");
    expect(authColumn).toHaveClass("sm:max-w-[260px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[1.48rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.82rem]");
    expect(authColumn).toHaveClass("lg:max-w-[344px]");
    expect(authColumn).toHaveClass("xl:mr-[1.78rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.2rem]");
    expect(authColumn).toHaveClass("xl:max-w-[364px]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[508px]");
    expect(authCard).toHaveClass("xl:max-w-[524px]");
    expect(authCard).toHaveClass("rounded-[0.78rem]");
    expect(authCard).toHaveClass("border-[rgba(247,249,252,0.86)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.974)_0%,rgba(249,244,237,0.46)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.0025),0_1px_2px_rgba(241,180,135,0.00055)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.05px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[258px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[512px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[528px]");
    expect(authCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.82rem]");
