...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[172px]");
    expect(authColumn).toHaveClass("sm:max-w-[184px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[0.03rem]");
    expect(authColumn).toHaveClass("lg:-mt-[15.02rem]");
    expect(authColumn).toHaveClass("lg:max-w-[224px]");
    expect(authColumn).toHaveClass("xl:mr-[0.16rem]");
    expect(authColumn).toHaveClass("xl:-mt-[15.28rem]");
    expect(authColumn).toHaveClass("xl:max-w-[244px]");
