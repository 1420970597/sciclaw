...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.02rem]");
    ...
    expect(authColumn).toHaveClass("xl:mt-[0.18rem]");
    ...
    expect(authCard).toHaveClass("max-w-[210px]");
    expect(authCard).toHaveClass("rounded-[1.22rem]");
    expect(authCard).toHaveClass("border-[rgba(237,241,245,0.96)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(249,245,240,0.962)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_6px_14px_rgba(15,23,42,0.04),0_2px_5px_rgba(241,180,135,0.018)]");
