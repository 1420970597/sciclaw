...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[1.84rem]");
    ...
    expect(authColumn).toHaveClass("lg:-mt-[10.86rem]");
    expect(authColumn).toHaveClass("lg:max-w-[440px]");
    expect(authColumn).toHaveClass("xl:mr-[0.3rem]");
    expect(authColumn).toHaveClass("xl:-mt-[11.18rem]");
    expect(authColumn).toHaveClass("xl:max-w-[456px]");
    expect(authColumn).not.toHaveClass("lg:max-w-[448px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[464px]");
