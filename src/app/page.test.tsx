...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[2.28rem]");
    ...
    expect(authColumn).toHaveClass("lg:mr-[0.54rem]");
    expect(authColumn).toHaveClass("lg:-mt-[17.04rem]");
    expect(authColumn).toHaveClass("lg:max-w-[296px]");
    expect(authColumn).toHaveClass("xl:mr-[0.74rem]");
    expect(authColumn).toHaveClass("xl:-mt-[17.38rem]");
    expect(authColumn).toHaveClass("xl:max-w-[316px]");
    expect(authColumn).not.toHaveClass("max-w-[236px]");
    expect(authColumn).not.toHaveClass("sm:max-w-[248px]");
    expect(authColumn).not.toHaveClass("lg:mr-[0.62rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[0.82rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.84rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[17.2rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[304px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[324px]");
