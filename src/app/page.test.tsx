...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(bestCasesSection).toHaveClass("mt-[2.36rem]");
    expect(bestCasesSection).toHaveClass("sm:mt-[2.88rem]");
    expect(bestCasesSection).toHaveClass("lg:mt-[5.42rem]");
    expect(bestCasesSection).toHaveClass("xl:mt-[5.84rem]");
    expect(bestCasesSection.firstElementChild).toHaveClass("mb-7");
    ...
    expect(authColumn).toHaveClass("lg:-mt-[10.08rem]");
    expect(authColumn).toHaveClass("lg:max-w-[532px]");
    expect(authColumn).toHaveClass("xl:-mt-[10.42rem]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[528px]");
    expect(authCard).toHaveClass("xl:max-w-[544px]");
    expect(authCard).toHaveClass("rounded-[0.9rem]");
    expect(authCard).toHaveClass("border-[rgba(244,247,250,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.76)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_5px_rgba(15,23,42,0.01),0_1px_2px_rgba(241,180,135,0.003)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.24px]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[278px]");
