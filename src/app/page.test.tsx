...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:-mt-[1.56rem]");
    ...
    expect(authColumn).toHaveClass("-mt-[0.24rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[352px]");
    expect(authColumn).toHaveClass("sm:max-w-[364px]");
    expect(authColumn).toHaveClass("lg:-mt-[2.52rem]");
    expect(authColumn).toHaveClass("lg:max-w-[624px]");
    expect(authColumn).toHaveClass("xl:-mt-[2.68rem]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[612px]");
    expect(authCard).toHaveClass("xl:max-w-[628px]");
    expect(authCard).toHaveClass("rounded-[1rem]");
    expect(authCard).toHaveClass("border-[rgba(234,240,246,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.998)_0%,rgba(251,246,240,0.9)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_5px_12px_rgba(15,23,42,0.02),0_2px_6px_rgba(241,180,135,0.008)]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[308px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[612px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[628px]");
