...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.34rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.02rem]");
    ...
    expect(authCard).toHaveClass("max-w-[222px]");
    expect(authCard).toHaveClass("rounded-[1rem]");
    expect(authCard).toHaveClass("border-[rgba(243,247,250,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.94)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.012),0_1px_2px_rgba(241,180,135,0.006)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.72px]");
