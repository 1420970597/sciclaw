...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(hero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_242px]");
    expect(hero).toHaveClass("lg:items-start");
    expect(hero).toHaveClass("lg:gap-[0.28rem]");
    expect(hero).toHaveClass("xl:-mt-[3.16rem]");
    expect(hero).toHaveClass("xl:grid-cols-[minmax(0,1.12fr)_242px]");
    expect(hero).toHaveClass("xl:gap-[0.36rem]");
    expect(authCard).toHaveClass("max-w-[242px]");
    ...
    expect(authCard).toHaveClass("lg:mt-[1.74rem]");
    expect(authCard).toHaveClass("xl:mt-[1.9rem]");
