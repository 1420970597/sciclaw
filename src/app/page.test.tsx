...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[0.82rem]");
    expect(authColumn).toHaveClass("w-full");
    expect(authColumn).toHaveClass("max-w-[332px]");
    expect(authColumn).toHaveClass("sm:max-w-[344px]");
    expect(authColumn).toHaveClass("lg:-mt-[5.58rem]");
    expect(authColumn).toHaveClass("lg:max-w-[588px]");
    expect(authColumn).toHaveClass("xl:-mt-[5.88rem]");
    expect(authColumn).toHaveClass("xl:max-w-[604px]");
    ...
    expect(authCard).toHaveClass("max-w-[268px]");
    expect(authCard).toHaveClass("lg:max-w-[588px]");
    expect(authCard).toHaveClass("xl:max-w-[604px]");
    expect(authCard).toHaveClass("rounded-[0.98rem]");
    expect(authCard).toHaveClass("border-[rgba(236,242,247,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.997)_0%,rgba(251,246,240,0.885)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.018),0_2px_5px_rgba(241,180,135,0.007)]");
    ...
    expect(authCard.firstElementChild).toHaveClass("max-w-[300px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[588px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[604px]");
    expect(previewCard).toHaveClass("rounded-[2.08rem]");
    expect(previewCard).toHaveClass("border-[rgba(205,214,224,0.98)]");
    expect(previewCard).toHaveClass("bg-[linear-gradient(180deg,#fcfaf7_0%,#e6edf5_100%)]");
    expect(previewCard).toHaveClass("shadow-[0_22px_44px_rgba(15,23,42,0.118)]");
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and improves hero cluster/label readability after the cohesion pass", () => {
    ...
    expect(literatureNode.parentElement?.className).toContain("left-[46.6%]");
    ...
    expect(literatureNodeWrapper?.parentElement?.querySelector("span[class*='w-[12.4%]']")).not.toBeNull();
    ...
    expect(literatureNodeLabel).toHaveClass("left-[-2.16rem]");
    expect(literatureNodeLabel).toHaveClass("top-[0.02rem]");
    ...
    expect(outcomeNodeLabel).toHaveClass("max-w-[110px]");
    expect(outcomeNodeLabel).not.toHaveClass("whitespace-nowrap");
    expect(outcomeNodeLabel).toHaveClass("left-[2.52rem]");
    expect(outcomeNodeLabel).toHaveClass("top-[-0.04rem]");
