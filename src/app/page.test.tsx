...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).not.toHaveClass("xl:-mt-[11.88rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[11.54rem]");
