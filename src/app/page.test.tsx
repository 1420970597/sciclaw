...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("-mt-[1.68rem]");
    ...
    expect(authColumn).toHaveClass("lg:-mt-[8.62rem]");
    ...
    expect(authCard).toHaveClass("rounded-[0.94rem]");
    expect(authCard).toHaveClass("border-[rgba(243,246,249,0.98)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,246,240,0.8)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_3px_rgba(241,180,135,0.0035)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.3px]");
