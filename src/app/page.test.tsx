...
describe("Home landing page", () => {
  ...
  it("keeps the utility triggers subtle, preserves the settings menu contract, and keeps the hero micro-label set readable after the cluster reposition", () => {
    ...
    expect(literatureNode).toHaveClass("left-[52.35%]");
    expect(literatureNode).toHaveClass("top-[18.45%]");
    expect(literatureNode.firstElementChild).toHaveClass("h-[4.24rem]");
    expect(literatureNode.firstElementChild).toHaveClass("w-[4.24rem]");
    ...
    expect(literatureNode.firstElementChild).toHaveClass("shadow-[0_0_0_3px_rgba(240,142,79,0.054),0_15px_28px_rgba(232,124,55,0.09)]");
    expect(literatureNode.lastElementChild).toHaveClass("text-[#864015]");
    expect(dataMiningNode).toHaveClass("left-[52.6%]");
    expect(dataMiningNode).toHaveClass("top-[48.55%]");
    ...
    expect(dataMiningNode.firstElementChild).toHaveClass("shadow-[0_13px_26px_rgba(15,23,42,0.09)]");
    expect(dataMiningNode.lastElementChild).toHaveClass("text-[#2f4d63]");
    expect(outcomeNode).toHaveClass("right-[34.75%]");
    ...
    expect(outcomeNode.firstElementChild).toHaveClass("shadow-[0_13px_26px_rgba(15,23,42,0.09)]");
    expect(outcomeNode.lastElementChild).toHaveClass("text-[#2f4d63]");
