...
describe("Home landing page", () => {
  ...
  it("renders the public-inspired landing structure", () => {
    ...
    expect(authColumn).toHaveClass("max-w-[258px]");
    expect(authColumn).toHaveClass("sm:max-w-[270px]");
    expect(authColumn).toHaveClass("lg:ml-auto");
    expect(authColumn).toHaveClass("lg:mr-[1.58rem]");
    expect(authColumn).toHaveClass("lg:-mt-[16.34rem]");
    expect(authColumn).toHaveClass("lg:max-w-[370px]");
    expect(authColumn).toHaveClass("xl:mr-[1.82rem]");
    expect(authColumn).toHaveClass("xl:-mt-[16.72rem]");
    expect(authColumn).toHaveClass("xl:max-w-[390px]");
    expect(authColumn).not.toHaveClass("lg:mr-[1.74rem]");
    expect(authColumn).not.toHaveClass("xl:mr-[1.98rem]");
    expect(authColumn).not.toHaveClass("lg:-mt-[16.12rem]");
    expect(authColumn).not.toHaveClass("xl:-mt-[16.5rem]");
    expect(authColumn).not.toHaveClass("lg:max-w-[380px]");
    expect(authColumn).not.toHaveClass("xl:max-w-[400px]");
    ...
    expect(authCard).toHaveClass("lg:max-w-[544px]");
    expect(authCard).toHaveClass("xl:max-w-[560px]");
    expect(authCard).toHaveClass("rounded-[0.84rem]");
    expect(authCard).toHaveClass("border-[rgba(247,249,252,0.94)]");
    expect(authCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.988)_0%,rgba(251,246,240,0.62)_100%)]");
    expect(authCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.005),0_1px_2px_rgba(241,180,135,0.0012)]");
    expect(authCard).toHaveClass("backdrop-blur-[0.12px]");
    expect(authCard).toHaveClass("mx-auto");
    expect(authCard.firstElementChild).toHaveClass("max-w-[274px]");
    expect(authCard.firstElementChild).toHaveClass("lg:max-w-[548px]");
    expect(authCard.firstElementChild).toHaveClass("xl:max-w-[564px]");
    expect(authCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.84rem]");
