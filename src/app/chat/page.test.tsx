...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:gap-[0.16rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.095fr)_280px]");
    expect(chatHero).toHaveClass("xl:gap-[0.26rem]");
    expect(chatAuthCard).toHaveClass("max-w-[268px]");
    expect(chatAuthCard).toHaveClass("bg-[#fcfdff]");
    expect(chatAuthCard).toHaveClass("border-[#f4f6f8]");
    expect(chatAuthCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.017),0_2px_5px_rgba(241,180,135,0.01)]");
