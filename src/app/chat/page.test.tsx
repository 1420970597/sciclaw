...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.22rem]");
    ...
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.28rem]");
    ...
    expect(chatAuthCard).toHaveClass("rounded-[1.18rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(240,244,248,0.96)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(250,246,241,0.958)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.03),0_1px_4px_rgba(241,180,135,0.015)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[1.5px]");
