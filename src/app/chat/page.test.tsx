...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("max-w-[222px]");
    expect(chatAuthCard).toHaveClass("rounded-[1rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(243,247,250,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.94)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.012),0_1px_2px_rgba(241,180,135,0.006)]");
