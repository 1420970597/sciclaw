...
describe("Chat app shell placeholder", () => {
  ...
  it("shows durable project memory, focused flow cards, and session cards that reflect the public docs concepts", () => {
    ...
    expect(utilityBandElement).toHaveClass("xl:grid-cols-[repeat(3,minmax(0,14rem))]");
  ...
  it("keeps the lower center strip as a calmer three-card checkpoint rail after the density pass", () => {
    ...
    expect(primaryTimelineGrid).toHaveClass("xl:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]");
    expect(primaryTimelineGrid).toHaveClass("2xl:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)]");
