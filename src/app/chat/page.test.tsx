...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[568px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[584px]");
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[560px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[576px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.88rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(247,249,252,0.94)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(251,246,240,0.64)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.006),0_1px_2px_rgba(241,180,135,0.0015)]");
