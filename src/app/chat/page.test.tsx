...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_254px]");
    ...
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.12fr)_254px]");
    ...
    expect(chatAuthCard).toHaveClass("lg:mt-[2.18rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.38rem]");
