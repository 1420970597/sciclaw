...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.82rem]");
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[508px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[524px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.78rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(247,249,252,0.86)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.974)_0%,rgba(249,244,237,0.46)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.0025),0_1px_2px_rgba(241,180,135,0.00055)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.05px]");
    expect(chatAuthCard).toHaveClass("mx-auto");
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[258px]");
