...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[286px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[592px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[608px]");
    ...
    expect(within(chatHero).getByTestId("feature-node-literature-analysis").parentElement?.className).toContain("left-[48.6%]");
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-2.14rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("top-[-0.14rem]");
    ...
    expect(within(chatHero).getByText(/^data mining$/i)).toHaveClass("top-[calc(100%-0.42rem)]");
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("sm:left-[-2.2rem]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[252px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[584px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[600px]");
