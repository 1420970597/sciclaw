...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("rounded-[1.28rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(230,235,241,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(249,245,240,0.974)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_10px_22px_rgba(15,23,42,0.058),0_2px_8px_rgba(241,180,135,0.03)]");
