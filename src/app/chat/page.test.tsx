...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[552px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[568px]");
    ...
    expect(chatAuthCard).toHaveClass("rounded-[0.94rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(243,246,249,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,246,240,0.8)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_3px_rgba(241,180,135,0.0035)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.3px]");
