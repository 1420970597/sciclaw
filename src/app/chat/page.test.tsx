...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("border-[#f4f7fa]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_3px_rgba(241,180,135,0.006)]");
    expect(chatAuthCard).toHaveClass("lg:mt-[2.64rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.84rem]");
    ...
    expect(chatPreviewLabelRow).toHaveClass("mt-[3.08rem]");
    expect(chatPreviewLabelRow).toHaveClass("gap-[3.46rem]");
    expect(chatPreviewLabelRow).toHaveClass("pt-[3.06rem]");
