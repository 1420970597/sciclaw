...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_228px]");
    ...
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_228px]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.32rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.08rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.4rem]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[218px]");
    expect(chatAuthCard).toHaveClass("rounded-[1rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(244,247,250,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(252,248,243,0.928)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_5px_rgba(15,23,42,0.01),0_1px_2px_rgba(241,180,135,0.004)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.54px]");
