...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_226px]");
    expect(chatFeaturePreview).toHaveClass("lg:items-start");
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.34rem]");
    expect(chatFeaturePreview).toHaveClass("lg:gap-y-[0.94rem]");
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_226px]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.42rem]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[216px]");
    expect(chatAuthCard).toHaveClass("rounded-[1.26rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(233,238,243,0.96)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(249,245,240,0.968)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_8px_18px_rgba(15,23,42,0.048),0_2px_6px_rgba(241,180,135,0.022)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[2px]");
