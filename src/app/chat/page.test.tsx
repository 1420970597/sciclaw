...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_224px]");
    expect(chatFeaturePreview).toHaveClass("lg:items-start");
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.04rem]");
    expect(chatFeaturePreview).toHaveClass("lg:gap-y-[0.72rem]");
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_224px]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("max-w-[112px]");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[3.1rem]");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("top-[0.14rem]");
    ...
    expect(chatHero.querySelector("span[class*='w-[10.95%]']")).not.toBeNull();
