...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_292px]");
    expect(chatHero).toHaveClass("lg:gap-[0.42rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.075fr)_292px]");
    expect(chatHero).toHaveClass("xl:gap-[0.58rem]");
    expect(chatAuthCard).toHaveClass("max-w-[282px]");
    expect(chatAuthCard).toHaveClass("bg-[#fcfdff]");
    expect(chatAuthCard).toHaveClass("border-[#eef2f6]");
    expect(chatAuthCard).toHaveClass("shadow-[0_8px_18px_rgba(15,23,42,0.026),0_2px_8px_rgba(241,180,135,0.018)]");
    expect(chatAuthCard).toHaveClass("lg:mt-[2.56rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.82rem]");
