...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_304px]");
    expect(chatHero).toHaveClass("lg:gap-[0.7rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.055fr)_304px]");
    expect(chatHero).toHaveClass("xl:gap-[0.9rem]");
    expect(chatAuthCard).toHaveClass("max-w-[304px]");
    expect(chatAuthCard).toHaveClass("bg-[#fdfefe]");
    expect(chatAuthCard).toHaveClass("border-[#eff3f7]");
    expect(chatAuthCard).toHaveClass("lg:mt-[1.82rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.04rem]");
