...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("max-w-[120px]");
    ...
    expect(within(chatHero).getByText(/^data mining$/i)).toHaveClass("max-w-[122px]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("max-w-[118px]");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("whitespace-nowrap");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[1.52rem]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("sm:left-[1.62rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("sm:left-[-1.8rem]");
