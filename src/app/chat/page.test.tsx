...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[528px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[544px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.9rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(244,247,250,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.76)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_5px_rgba(15,23,42,0.01),0_1px_2px_rgba(241,180,135,0.003)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.24px]");
