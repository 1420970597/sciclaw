...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:-mt-[1.28rem]");
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[308px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[612px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[628px]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[276px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[612px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[628px]");
    expect(chatAuthCard).toHaveClass("rounded-[1rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(234,240,246,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.998)_0%,rgba(251,246,240,0.9)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_5px_12px_rgba(15,23,42,0.02),0_2px_6px_rgba(241,180,135,0.008)]");
