...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_218px]");
    expect(chatFeaturePreview).toHaveClass("lg:items-start");
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.02rem]");
    expect(chatFeaturePreview).toHaveClass("lg:gap-y-[0.64rem]");
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_218px]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.04rem]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-y-[0.72rem]");
