...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(screen.getByRole("button", { name: /user guide/i })).toHaveClass("border-[rgba(15,23,42,0.22)]");
    expect(screen.getByRole("button", { name: /user guide/i })).toHaveClass("bg-white/72");
    expect(screen.getByRole("button", { name: /contact us/i })).toHaveClass("border-[rgba(15,23,42,0.22)]");
    expect(screen.getByRole("button", { name: /settings/i })).toHaveClass("shadow-[0_10px_22px_rgba(15,23,42,0.065)]");
    ...
    expect(chatHero).toHaveClass("lg:-mt-[1.86rem]");
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_232px]");
    expect(chatFeaturePreview).toHaveClass("lg:items-start");
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.42rem]");
    expect(chatFeaturePreview).toHaveClass("lg:gap-y-[0.94rem]");
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_232px]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.5rem]");
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.18rem]");
    ...
    expect(authColumn).toHaveClass("xl:-ml-[0.24rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.36rem]");
    ...
    expect(within(chatHero).getByTestId("feature-node-literature-analysis").parentElement?.className).toContain("left-[47.2%]");
    expect(within(chatHero).getByTestId("feature-node-data-mining").parentElement?.className).toContain("left-[47.3%]");
    expect(within(chatHero).getByTestId("feature-node-outcome-present").parentElement?.className).toContain("right-[16.85%]");
    ...
    expect(chatHero.querySelector("span[class*='w-[11.1%]']")).not.toBeNull();
    ...
    expect(chatAuthCard).toHaveClass("max-w-[226px]");
    expect(chatAuthCard).toHaveClass("rounded-[1.34rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(236,241,246,0.94)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.988)_0%,rgba(250,246,241,0.962)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_10px_24px_rgba(15,23,42,0.05),0_2px_8px_rgba(241,180,135,0.032)]");
    ...
    expect(chatPreviewCard).toHaveClass("border-[rgba(255,255,255,0.94)]");
    expect(chatPreviewCard).toHaveClass("bg-[linear-gradient(180deg,#ffffff_0%,#f5f7fa_100%)]");
    expect(chatPreviewCard).toHaveClass("shadow-[0_18px_40px_rgba(15,23,42,0.07)]");
