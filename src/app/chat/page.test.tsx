...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_288px]");
    expect(chatHero).toHaveClass("lg:gap-[0.26rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.075fr)_288px]");
    expect(chatHero).toHaveClass("xl:gap-[0.38rem]");
    expect(chatAuthCard).toHaveClass("max-w-[278px]");
    expect(chatAuthCard).toHaveClass("bg-[#fdfdff]");
    expect(chatAuthCard).toHaveClass("border-[#f1f4f7]");
    expect(chatAuthCard).toHaveClass("shadow-[0_6px_14px_rgba(15,23,42,0.022),0_2px_7px_rgba(241,180,135,0.014)]");
