...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:gap-[0.2rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.085fr)_284px]");
    expect(chatHero).toHaveClass("xl:gap-[0.32rem]");
    expect(chatAuthCard).toHaveClass("max-w-[272px]");
    expect(chatAuthCard).toHaveClass("bg-[#fcfdff]");
    expect(chatAuthCard).toHaveClass("border-[#f3f5f8]");
    expect(chatAuthCard).toHaveClass("shadow-[0_5px_12px_rgba(15,23,42,0.019),0_2px_6px_rgba(241,180,135,0.012)]");
    expect(chatAuthCard).toHaveClass("lg:mt-[2.5rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.72rem]");
