...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[282px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[584px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[600px]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("max-w-[132px]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("top-[0.4rem]");
    ...
    expect(chatHero.querySelector("span[class*='top-[27.66%]'][class*='w-[9.98%]'][class*='rotate-[10deg]']")).not.toBeNull();
    expect(chatHero).not.toHaveClass("xl:grid-cols-[minmax(0,1.08fr)_232px]");
    expect(chatAuthCard).toHaveClass("max-w-[248px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[576px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[592px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.88rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(246,248,251,0.95)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(251,246,240,0.68)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.007),0_1px_2px_rgba(241,180,135,0.0018)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.14px]");
