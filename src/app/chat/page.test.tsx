...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.026),0_1px_3px_rgba(241,180,135,0.013)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[1.25px]");
