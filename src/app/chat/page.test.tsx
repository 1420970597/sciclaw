...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[288px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[448px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[462px]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[256px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[448px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[462px]");
