...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("max-w-[232px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[532px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[548px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.84rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(248,250,252,0.9)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.982)_0%,rgba(250,246,240,0.54)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.004),0_1px_2px_rgba(241,180,135,0.0008)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.08px]");
    expect(chatAuthCard).toHaveClass("mx-auto");
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[266px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[536px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[552px]");
    expect(chatAuthCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.84rem]");
