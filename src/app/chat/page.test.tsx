...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_214px]");
    ...
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_214px]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.06rem]");
    ...
    expect(authColumn).toHaveClass("lg:-ml-[0.1rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.28rem]");
    expect(authColumn).toHaveClass("lg:max-w-[13.9rem]");
    expect(authColumn).toHaveClass("xl:-ml-[0.06rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.34rem]");
    ...
    expect(within(chatHero).getByTestId("feature-node-literature-analysis").parentElement?.className).toContain("left-[48.85%]");
    expect(within(chatHero).getByTestId("feature-node-data-mining").parentElement?.className).toContain("left-[48.7%]");
    expect(within(chatHero).getByTestId("feature-node-outcome-present").parentElement?.className).toContain("right-[15.6%]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("max-w-[104px]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-1.58rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("top-[0.16rem]");
    expect(within(chatHero).getByText(/^data mining$/i)).toHaveClass("max-w-[104px]");
    expect(within(chatHero).getByText(/^data mining$/i)).toHaveClass("top-[calc(100%-0.06rem)]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[2.22rem]");
    ...
    expect(chatHero.querySelector("span[class*='w-[10.35%]']")).not.toBeNull();
    expect(chatHero.querySelector("span[class*='w-[10.2%]']")).not.toBeNull();
    expect(chatHero.querySelector("span[class*='top-[28.72%]'][class*='w-[10.3%]'][class*='rotate-[12deg]']")).not.toBeNull();
    expect(chatHero).not.toHaveClass("xl:grid-cols-[minmax(0,1.08fr)_232px]");
    expect(chatAuthCard).toHaveClass("max-w-[214px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.98rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(245,248,251,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(252,248,243,0.92)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_4px_rgba(15,23,42,0.008),0_1px_2px_rgba(241,180,135,0.003)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.5px]");
