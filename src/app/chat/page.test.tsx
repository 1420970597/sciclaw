...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_232px]");
    expect(chatHero).toHaveClass("lg:gap-[0.1rem]");
    ...
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.08fr)_232px]");
    expect(chatHero).toHaveClass("xl:gap-[0.14rem]");
    ...
    expect(chatAuthCard).toHaveClass("lg:mt-[2.16rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.3rem]");
