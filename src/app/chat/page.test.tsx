...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.997)_0%,rgba(252,248,243,0.95)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.013),0_1px_2px_rgba(241,180,135,0.006)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.68px]");
