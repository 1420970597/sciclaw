...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[300px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[588px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[604px]");
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-2.16rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("top-[0.02rem]");
    ...
    expect(chatAuthCard).toHaveClass("xl:max-w-[604px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.98rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(236,242,247,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.997)_0%,rgba(251,246,240,0.885)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.018),0_2px_5px_rgba(241,180,135,0.007)]");
    ...
    expect(chatPreviewCard).toHaveClass("border-[rgba(205,214,224,0.98)]");
    expect(chatPreviewCard).toHaveClass("bg-[linear-gradient(180deg,#fcfaf7_0%,#e6edf5_100%)]");
    expect(chatPreviewCard).toHaveClass("shadow-[0_22px_44px_rgba(15,23,42,0.118)]");
