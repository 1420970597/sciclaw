...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("border-[rgba(241,245,249,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(251,247,242,0.95)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_4px_10px_rgba(15,23,42,0.022),0_1px_3px_rgba(241,180,135,0.01)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.88px]");
