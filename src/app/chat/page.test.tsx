...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(within(chatHero).getByTestId("feature-node-literature-analysis").parentElement?.className).toContain("left-[45.36%]");
    expect(within(chatHero).getByTestId("feature-node-data-mining").parentElement?.className).toContain("left-[45.04%]");
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-1.72rem]");
    ...
    expect(chatHero.querySelector("span[class*='w-[12.9%]']")).not.toBeNull();
    expect(chatHero.querySelector("span[class*='w-[13.62%]']")).not.toBeNull();
    ...
    expect(chatAuthCard).toHaveClass("max-w-[204px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[452px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[468px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.7rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(226,232,239,0.9)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.982)_0%,rgba(249,245,239,0.79)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_8px_18px_rgba(15,23,42,0.032),0_3px_6px_rgba(241,180,135,0.034)]");
    ...
    expect(chatAuthCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.78rem]");
    expect(chatAuthCard).not.toHaveClass("max-w-[208px]");
    expect(chatAuthCard).not.toHaveClass("lg:max-w-[460px]");
    expect(chatAuthCard).not.toHaveClass("xl:max-w-[476px]");
