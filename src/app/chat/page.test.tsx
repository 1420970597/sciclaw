...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[2.02rem]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("sm:left-[2.1rem]");
