...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:-mt-[2.56rem]");
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_266px]");
    ...
    expect(chatHero).toHaveClass("xl:-mt-[2.84rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.12fr)_266px]");
    ...
    expect(chatAuthCard).toHaveClass("lg:mt-[2.9rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[3.12rem]");
