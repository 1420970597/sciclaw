...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[268px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[404px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[420px]");
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[404px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[420px]");
