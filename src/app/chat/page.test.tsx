...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.11fr)_272px]");
    expect(chatHero).toHaveClass("xl:gap-[0.18rem]");
    expect(chatAuthCard).toHaveClass("max-w-[260px]");
    expect(chatAuthCard).toHaveClass("bg-[#fcfdff]");
    expect(chatAuthCard).toHaveClass("border-[#f5f7f9]");
    expect(chatAuthCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.014),0_2px_4px_rgba(241,180,135,0.008)]");
    expect(chatAuthCard).toHaveClass("lg:mt-[2.56rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.76rem]");
