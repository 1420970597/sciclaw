...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:grid-cols-[minmax(0,1fr)_200px]");
    expect(chatFeaturePreview).toHaveClass("lg:items-start");
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.1rem]");
    expect(chatFeaturePreview).toHaveClass("lg:gap-y-[0.9rem]");
    expect(chatFeaturePreview).toHaveClass("xl:grid-cols-[minmax(0,1fr)_200px]");
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.16rem]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[190px]");
    expect(chatAuthCard).toHaveClass("rounded-[1.1rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(243,246,249,0.97)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.995)_0%,rgba(251,247,242,0.948)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.022),0_1px_3px_rgba(241,180,135,0.011)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[1px]");
