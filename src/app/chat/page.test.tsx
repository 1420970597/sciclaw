...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_308px]");
    expect(chatHero).toHaveClass("lg:gap-[0.84rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.04fr)_308px]");
    expect(chatHero).toHaveClass("xl:gap-[1.02rem]");
    expect(chatAuthCard).toHaveClass("max-w-[308px]");
    expect(chatAuthCard).toHaveClass("bg-[#fcfdff]");
    expect(chatAuthCard).toHaveClass("border-[#edf1f5]");
    expect(chatAuthCard).toHaveClass("lg:mt-[1.18rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[1.34rem]");
