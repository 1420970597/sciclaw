...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.08rem]");
    ...
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.12rem]");
    ...
    expect(authColumn).not.toHaveClass("lg:-ml-[0.14rem]");
    ...
    expect(authColumn).toHaveClass("lg:mt-[0.3rem]");
    expect(authColumn).not.toHaveClass("xl:-ml-[0.1rem]");
    expect(authColumn).toHaveClass("xl:mt-[0.38rem]");
    ...
    expect(chatAuthCard).toHaveClass("rounded-[1.02rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(243,246,249,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(252,248,243,0.93)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.011),0_1px_2px_rgba(241,180,135,0.005)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.58px]");
