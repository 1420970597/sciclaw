...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.28rem]");
    ...
    expect(chatFeaturePreview).toHaveClass("xl:gap-x-[0.34rem]");
    ...
    expect(chatAuthCard).toHaveClass("rounded-[1.22rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(237,241,245,0.96)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.992)_0%,rgba(249,245,240,0.962)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_6px_14px_rgba(15,23,42,0.04),0_2px_5px_rgba(241,180,135,0.018)]");
