...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.84rem]");
    ...
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-1.76rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("top-[0.38rem]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[1.62rem]");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("top-[0.42rem]");
    expect(within(chatHero).getByText(/^outcome present$/i)).not.toHaveClass("-translate-y-1/2");
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("sm:left-[1.72rem]");
    ...
    expect(chatAuthCard).toHaveClass("max-w-[228px]");
    expect(chatAuthCard).toHaveClass("lg:max-w-[520px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[536px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.8rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(247,249,252,0.88)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.978)_0%,rgba(249,244,237,0.5)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.003),0_1px_2px_rgba(241,180,135,0.00065)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.06px]");
    expect(chatAuthCard).toHaveClass("mx-auto");
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[262px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[524px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[540px]");
    expect(chatAuthCard.firstElementChild?.firstElementChild).toHaveClass("rounded-[0.84rem]");
