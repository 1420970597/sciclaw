...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatFeaturePreview).toHaveClass("lg:gap-x-[0.01rem]");
    ...
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.994)_0%,rgba(251,247,242,0.93)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_2px_6px_rgba(15,23,42,0.014),0_1px_2px_rgba(241,180,135,0.007)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.72px]");
