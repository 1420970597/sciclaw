...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[544px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[560px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.84rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(247,249,252,0.94)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.988)_0%,rgba(251,246,240,0.62)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_1px_2px_rgba(15,23,42,0.005),0_1px_2px_rgba(241,180,135,0.0012)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.12px]");
