...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(within(chatHero).getByTestId("feature-node-literature-analysis").parentElement?.className).toContain("left-[48.4%]");
    expect(within(chatHero).getByTestId("feature-node-data-mining").parentElement?.className).toContain("left-[48.25%]");
    expect(within(chatHero).getByTestId("feature-node-outcome-present").parentElement?.className).toContain("right-[16.2%]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("max-w-[104px]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("left-[-1.84rem]");
    expect(within(chatHero).getByText(/^literature analysis$/i)).toHaveClass("top-[0.28rem]");
    ...
    expect(within(chatHero).getByText(/^outcome present$/i)).toHaveClass("left-[2.46rem]");
    ...
    expect(chatHero.querySelector("span[class*='w-[10.8%]']")).not.toBeNull();
    expect(chatHero.querySelector("span[class*='w-[10.6%]']")).not.toBeNull();
    expect(chatHero.querySelector("span[class*='top-[28.95%]'][class*='w-[10.7%]'][class*='rotate-[12deg]']")).not.toBeNull();
