...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatAuthCard.firstElementChild).toHaveClass("max-w-[294px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("lg:max-w-[580px]");
    expect(chatAuthCard.firstElementChild).toHaveClass("xl:max-w-[596px]");
    ...
    expect(chatAuthCard).toHaveClass("lg:max-w-[580px]");
    expect(chatAuthCard).toHaveClass("xl:max-w-[596px]");
    expect(chatAuthCard).toHaveClass("rounded-[0.98rem]");
    expect(chatAuthCard).toHaveClass("border-[rgba(239,244,248,0.98)]");
    expect(chatAuthCard).toHaveClass("bg-[linear-gradient(180deg,rgba(255,255,255,0.996)_0%,rgba(250,245,239,0.84)_100%)]");
    expect(chatAuthCard).toHaveClass("shadow-[0_3px_8px_rgba(15,23,42,0.014),0_2px_4px_rgba(241,180,135,0.005)]");
    expect(chatAuthCard).toHaveClass("backdrop-blur-[0.4px]");
