...
describe("Chat route public landing clone", () => {
  it("renders the same marketing landing shell as the public live /chat route on fresh load", () => {
    ...
    expect(chatHero).toHaveClass("lg:grid-cols-[minmax(0,1fr)_296px]");
    expect(chatHero).toHaveClass("lg:gap-[0.5rem]");
    expect(chatHero).toHaveClass("xl:grid-cols-[minmax(0,1.07fr)_296px]");
    expect(chatHero).toHaveClass("xl:gap-[0.68rem]");
    expect(chatAuthCard).toHaveClass("max-w-[286px]");
    expect(chatAuthCard).toHaveClass("bg-white");
    expect(chatAuthCard).toHaveClass("border-[#ebeff4]");
    expect(chatAuthCard).toHaveClass("shadow-[0_10px_24px_rgba(15,23,42,0.032),0_3px_10px_rgba(241,180,135,0.022)]");
    expect(chatAuthCard).toHaveClass("lg:mt-[2.42rem]");
    expect(chatAuthCard).toHaveClass("xl:mt-[2.68rem]");
